...
public class TROtherRequestA extends INBKAABase {
    ...
    public String processRequestData() throws Exception {
        ...
        try {
            ...
            if (!DbHelper.toBoolean(feptxn.getFeptxnCbsTimeout())) {//主機逾時，不回ATM
    ...
    private void checkBusinessRule() throws Exception {
		...
		logMessage(this.logContext);
		rtnCode = new ENCHelper(getATMtxData()).checkAtmMac(feptxn.getFeptxnAtmno(), StringUtils.substring(getATMtxData().getTxRequestMessage(), 36, 742), ATMMAC);
    ...
    private String labelEndOfFunc() throws Exception {
        ...
        try {
            ...
            if (rtnCode != FEPReturnCode.Normal) {
                ...
                atm_faa_cc1apc.setPRCRDACT("4"); // 晶片卡不留置:固定放”4”(不吃卡)
                ...
                atm_faa_cc1apc.setPRCCODE(TxHelper.getRCFromErrorCode(Objects.toString(rtnCode.getValue()), FEPChannel.FEP,
