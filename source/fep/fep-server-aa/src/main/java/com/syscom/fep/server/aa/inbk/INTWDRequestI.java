...
public class INTWDRequestI extends INBKAABase {
    ...
    private FEPReturnCode addTxData() {
        ...
        try {
            ...
            _rtnCode2 = getFiscBusiness().prepareIntltxn(intltxnRefBase, oriintltxnRefBase, MessageFlow.Request);
            ...
            _rtnCode3 = getFiscBusiness().insertINTLTxn(defINTLTXN);
            if (_rtnCode3 != CommonReturnCode.Normal) {
                transactionManager.rollback(txStatus);
                return _rtnCode3;
            }
