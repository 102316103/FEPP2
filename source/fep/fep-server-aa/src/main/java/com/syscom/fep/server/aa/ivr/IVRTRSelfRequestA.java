 ...
 * @author
 */
public class IVRTRSelfRequestA extends INBKAABase {
    ...
    public IVRTRSelfRequestA(IVRData txnData) throws Exception {
        super(txnData);
    }
...
//            }
            ...
            if (StringUtils.isNotBlank(this.getImsPropertiesValue(tota, ImsMethodName.IMSRC_TCB.getValue()))) {
