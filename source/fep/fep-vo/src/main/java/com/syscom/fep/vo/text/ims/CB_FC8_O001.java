...
public class CB_FC8_O001 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 170)
	private String FR8DATA = StringUtils.EMPTY;
	...
	public String getFR8DATA(){
        return this.FR8DATA;
	}

	public void setFR8DATA(String FR8DATA){
        this.FR8DATA = FR8DATA;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setFR8DATA(EbcdicConverter.fromHex(CCSID.English,tita.substring(204, 544)));
	...
	public String makeMessage() {
		return "" //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getFR8DATA(), 170) //
	...
	public String makeMessageAscii() {
		return "" //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getFR8DATA(), StringUtils.EMPTY), 170," ") //
