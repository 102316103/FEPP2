...
public class AB_TR_I001 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 14)
	private BigDecimal AE_TRANSAMTOUT;
	...
	public BigDecimal getAE_TRANSAMTOUT(){
        return this.AE_TRANSAMTOUT;
	}

	public void setAE_TRANSAMTOUT(BigDecimal AE_TRANSAMTOUT){
		this.AE_TRANSAMTOUT = AE_TRANSAMTOUT;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setAE_TRNSFROUTIDNO(EbcdicConverter.fromHex(CCSID.English,tita.substring(706, 726)));
        this.setAE_TRNSFLAG(EbcdicConverter.fromHex(CCSID.English,tita.substring(726, 728)));
        this.setAE_BUSINESSTYPE(EbcdicConverter.fromHex(CCSID.English,tita.substring(728, 730)));
        this.setAE_AEIEFEET(EbcdicConverter.fromHex(CCSID.English,tita.substring(730, 734)));
        this.setAE_TRNSFROUTNOTE(EbcdicConverter.changeChinese(tita.substring(734, 770)));
        this.setAE_AEISLLTY(EbcdicConverter.fromHex(CCSID.English,tita.substring(770, 772)));
        this.setAE_LIMITTYPE(EbcdicConverter.fromHex(CCSID.English,tita.substring(772, 776)));
        this.setAE_AEIFIXFE(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English,tita.substring(776, 780).trim()), false, 0));
        this.setAE_AEINETFE(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English,tita.substring(780, 784).trim()), false, 0));
        this.setAE_AEIEDIFE(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English,tita.substring(784, 788).trim()), false, 0));
        this.setAE_AEICIRCU(EbcdicConverter.fromHex(CCSID.English,tita.substring(788, 812)));
        this.setAE_AEIDSTYP(EbcdicConverter.fromHex(CCSID.English,tita.substring(812, 814)));
        this.setAE_AEIDSBRH(EbcdicConverter.fromHex(CCSID.English,tita.substring(814, 822)));
        this.setAE_AEIDSCRG(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English,tita.substring(822, 826).trim()), false, 0));
        this.setAE_TRANSAMTOUT(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English,tita.substring(826, 854).trim()), false, 2));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(854, 1200)));
	}
	...
	public String makeMessage() {
        ...
        + this.getTXNICCTAC()  //
            ...
            + CodeGenUtil.bigDecimalToEbcdic(this.getAE_TRANSAMTOUT(), 11, false, 2, true) //
	...
	public String makeMessageAscii() {
        ...
        + this.getTXNICCTAC()  //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getTXMEMO(), StringUtils.EMPTY), 40," ") //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getTO_ACT_MEMO(), StringUtils.EMPTY), 16," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getFROM_ACT_MEMO(), StringUtils.EMPTY), 16," ") //
            ...
            + CodeGenUtil.bigDecimalToAsciiCBS(this.getAE_TRANSAMTOUT(), 11, false, 2, true) //
