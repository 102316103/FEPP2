...
public class CB_FC6_O001 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 2)
	private String POFUNAEL = StringUtils.EMPTY;

    @Field(length = 8)
	private String POATMID = StringUtils.EMPTY;

    @Field(length = 17)
	private String POBALANC = StringUtils.EMPTY;

    @Field(length = 6)
	private String POFADATAA = StringUtils.EMPTY;

    @Field(length = 13)
	private String POFADATAB = StringUtils.EMPTY;

    @Field(length = 1)
	private String S1 = StringUtils.EMPTY;

    @Field(length = 20)
	private String POTADATA = StringUtils.EMPTY;

    @Field(length = 10)
	private String POSEQ = StringUtils.EMPTY;

    @Field(length = 8)
	private String POBUSINE = StringUtils.EMPTY;

    @Field(length = 3)
	private String PORTN = StringUtils.EMPTY;
	...
	public String getPOFUNAEL(){
        return this.POFUNAEL;
	}

	public void setPOFUNAEL(String POFUNAEL){
        this.POFUNAEL = POFUNAEL;
	}

	public String getPOATMID(){
        return this.POATMID;
	}

	public void setPOATMID(String POATMID){
        this.POATMID = POATMID;
	}

	public String getPOBALANC(){
        return this.POBALANC;
	}

	public void setPOBALANC(String POBALANC){
        this.POBALANC = POBALANC;
	}

	public String getPOFADATAA(){
        return this.POFADATAA;
	}

	public void setPOFADATAA(String POFADATAA){
        this.POFADATAA = POFADATAA;
	}

	public String getPOFADATAB(){
        return this.POFADATAB;
	}

	public void setPOFADATAB(String POFADATAB){
        this.POFADATAB = POFADATAB;
	}
	...
	public String getPOTADATA(){
        return this.POTADATA;
	}

	public void setPOTADATA(String POTADATA){
        this.POTADATA = POTADATA;
	}
	...
	public String getPOBUSINE(){
        return this.POBUSINE;
	}

	public void setPOBUSINE(String POBUSINE){
        this.POBUSINE = POBUSINE;
	}

	public String getPORTN(){
        return this.PORTN;
	}

	public void setPORTN(String PORTN){
        this.PORTN = PORTN;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setMSGTYP(EbcdicConverter.fromHex(CCSID.English,tita.substring(200, 204)));
        this.setPOFUNAEL(EbcdicConverter.fromHex(CCSID.English,tita.substring(204, 208)));
        this.setPOATMID(EbcdicConverter.fromHex(CCSID.English,tita.substring(208, 224)));
        this.setPOBALANC(EbcdicConverter.fromHex(CCSID.English,tita.substring(224, 258)));
        this.setPOFADATAA(EbcdicConverter.fromHex(CCSID.English,tita.substring(258, 270)));
        this.setPOFADATAB(EbcdicConverter.fromHex(CCSID.English,tita.substring(270, 296)));
        this.setS1(EbcdicConverter.fromHex(CCSID.English,tita.substring(296, 298)));
        this.setPOTADATA(EbcdicConverter.fromHex(CCSID.English,tita.substring(298, 338)));
        this.setPOSEQ(EbcdicConverter.fromHex(CCSID.English,tita.substring(338, 358)));
        this.setPOBUSINE(EbcdicConverter.fromHex(CCSID.English,tita.substring(358, 374)));
        this.setPORTN(EbcdicConverter.fromHex(CCSID.English,tita.substring(374, 380)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(380, 1200)));
	}
	...
	public String makeMessage() {
		return "" //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPOFUNAEL(), 2) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPOATMID(), 8) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPOBALANC(), 17) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPOFADATAA(), 6) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPOFADATAB(), 13) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getS1(), 1) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPOTADATA(), 20) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPOSEQ(), 10) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPOBUSINE(), 8) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPORTN(), 3) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 410) //
		;
	}
	...
	public String makeMessageAscii() {
		return "" //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getMSGTYP(), StringUtils.EMPTY), 2," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getPOFUNAEL(), StringUtils.EMPTY), 2," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getPOATMID(), StringUtils.EMPTY), 8," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getPOBALANC(), StringUtils.EMPTY), 17," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getPOFADATAA(), StringUtils.EMPTY), 6," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getPOFADATAB(), StringUtils.EMPTY), 13," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getS1(), StringUtils.EMPTY), 1," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getPOTADATA(), StringUtils.EMPTY), 20," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getPOSEQ(), StringUtils.EMPTY), 10," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getPOBUSINE(), StringUtils.EMPTY), 8," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getPORTN(), StringUtils.EMPTY), 3," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 410," ") //
		;
	}
}
