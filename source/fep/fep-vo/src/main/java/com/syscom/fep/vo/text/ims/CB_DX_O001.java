...
public class CB_DX_O001 extends IMSTextBase {
    @Field(length = 8)
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setDXTVC(EbcdicConverter.fromHex(CCSID.English,tita.substring(354, 366)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(366, 1200)));
	}
	...
	public String makeMessage() {
		return "" //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 417) //
		;
	}
	...
	public String makeMessageAscii() {
		return "" //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDXTVC(), StringUtils.EMPTY), 6," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 417," ") //
		;
	}
}
