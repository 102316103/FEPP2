...
public abstract class MOUnisysTextBase extends TextBase<MOGeneral> {

	public abstract MOGeneral parseFlatfile(String flatfile) throws Exception;

	protected <T extends MOUnisysTextBase> MOGeneral parseFlatfile(Class<T> genericType, String flatfile) throws Exception {
		// 位數不夠右邊自動補齊16進制的空白符
		...
		MOGeneral general = new MOGeneral();
