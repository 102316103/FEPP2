...
public class ATM_FAA_CC1APC extends ATMTextBase {
	@Field(length = 5)
	...
	private static final int _TotalLength = 243;
	...
	public void setPARPC(String PARPC){
		this.PARPC = PARPC;
	}
	...
	public String makeMessage() {
	    ...
	    if(this.getPTXAMT().equals(StringUtils.EMPTY)){
	    	this.setPTXAMT(StringUtils.leftPad("$0",11,StringUtils.SPACE));
	    }else{
			this.setPTXAMT(StringUtils.leftPad(this.getPTXAMT(),11,StringUtils.SPACE));
	    }    
		this.setS6(StringUtils.rightPad(this.getS6(),2,StringUtils.SPACE));
	    if(this.getPFEE().equals(StringUtils.EMPTY)){
	    	this.setPFEE(StringUtils.leftPad("$0",4,StringUtils.SPACE));
	    }else{
			this.setPFEE(StringUtils.leftPad(this.getPFEE(),4,StringUtils.SPACE));
	    }    
		this.setS7(StringUtils.rightPad(this.getS7(),2,StringUtils.SPACE));
		this.setPBAL(StringUtils.rightPad(this.getPBAL(),18,StringUtils.SPACE));
		...
		this.setPAUTHAMT(StringUtils.rightPad(this.getPAUTHAMT(),11,StringUtils.SPACE));
		this.setS18(StringUtils.rightPad(this.getS18(),2,StringUtils.SPACE));
		this.setPARPC(StringUtils.rightPad(this.getPARPC(),16,StringUtils.SPACE));
		this.setS19(StringUtils.rightPad(this.getS19(),2,StringUtils.SPACE));
