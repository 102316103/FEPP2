...
public class CB_I5_O001 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 7)
	private String AUTHAMT = StringUtils.EMPTY;
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setAUTHAMT(EbcdicConverter.fromHex(CCSID.English,tita.substring(602, 616)));
	...
	public String makeMessage() {
		return "" //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getAUTHAMT(), 7) //
	...
	public String makeMessageAscii() {
		return "" //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getAUTHAMT(), StringUtils.EMPTY), 7," ") //
