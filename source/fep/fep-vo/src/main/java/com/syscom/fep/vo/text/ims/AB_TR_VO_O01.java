...
public class AB_TR_VO_O01 extends IMSTextBase {
    @Field(length = 8)
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setCLEANBRANCHOUT(EbcdicConverter.fromHex(CCSID.English,tita.substring(578, 586)));
        this.setFEEPAYMENTTYPE(EbcdicConverter.fromHex(CCSID.English,tita.substring(586, 590)));
        this.setCHAFEE_BRANCH(EbcdicConverter.fromHex(CCSID.English,tita.substring(590, 598)));
        this.setCHAFEEAMT(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English,tita.substring(598, 602).trim()), false, 0));
        this.setTRANSAMTOUT(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English,tita.substring(602, 630).trim()), false, 2));
        this.setTRANSOUTCUST(EbcdicConverter.fromHex(CCSID.English,tita.substring(630, 632)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(632, 1192)));
	}
	...
	public String makeMessage() {
		return "" 
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 280) 
		;
	}
	...
	public String makeMessageAscii() {
		return "" 
			...
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getO_ACT(), StringUtils.EMPTY), 12," ")
			...
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 280," ")
		;
	}
}
