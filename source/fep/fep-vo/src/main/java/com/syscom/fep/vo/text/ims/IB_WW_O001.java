...
public class IB_WW_O001 extends IMSTextBase {
    @Field(length = 8)
...
public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setAUTHCD(EbcdicConverter.fromHex(CCSID.English,tita.substring(554, 570)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(570, 1200)));
}
...
return "" //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getAUTHCD(), 8) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 315) //
;
}
...
return "" //
            ...
            + StringUtils.leftPad(this.getAUTHCD(), 8," ") //
            + StringUtils.leftPad(this.getDRVS(), 315," ") //
;
}
}
