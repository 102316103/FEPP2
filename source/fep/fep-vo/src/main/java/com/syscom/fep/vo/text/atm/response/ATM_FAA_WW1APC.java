...
public class ATM_FAA_WW1APC extends ATMTextBase {
	@Field(length = 5)
	...
	private static final int _TotalLength = 470;
	...
	public String makeMessage() {
		...
		this.setPACCNO(StringUtils.rightPad(this.getPACCNO(),19,StringUtils.SPACE));
		...
		this.setEMVAUTH(StringUtils.rightPad(this.getEMVAUTH(),8,StringUtils.SPACE));
		...
		this.setCARDCODE(StringUtils.rightPad(this.getCARDCODE(),2,StringUtils.SPACE));
		...
		this.setARPC(StringUtils.rightPad(this.getARPC(),257,StringUtils.SPACE));
		...
		return CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getWSID(),5) +
		      ...
		      CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPACCNO(),19) +
		      ...
		      CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getEMVAUTH(),8) +
		      ...
		      CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getCARDCODE(),2) +
		      ...
		      CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getARPC(),257)
		      ;
	}
