...
public class CB_FC5_O001 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 69)
	private String FR5DATA = StringUtils.EMPTY;
	...
	public String getFR5DATA(){
        return this.FR5DATA;
	}

	public void setFR5DATA(String FR5DATA){
        this.FR5DATA = FR5DATA;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setFR5DATA(EbcdicConverter.fromHex(CCSID.English,tita.substring(204, 342)));
	...
	public String makeMessage() {
		return "" //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getFR5DATA(), 69) //
	...
	public String makeMessageAscii() {
		return "" //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getFR5DATA(), StringUtils.EMPTY), 69," ") //
