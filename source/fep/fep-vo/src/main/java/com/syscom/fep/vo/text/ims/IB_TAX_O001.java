...
public class IB_TAX_O001 extends IMSTextBase {
    @Field(length = 8)
        private String IMS_TAXANS = StringUtils.EMPTY;
    ...
    @Field(length = 7)
        private String O_TAX_FROM_BRANCH = StringUtils.EMPTY;

    @Field(length = 316)
        private String DRVS = StringUtils.EMPTY;

        public String getIMS_TAXANS(){
        return this.IMS_TAXANS;
        }
        public void setIMS_TAXANS(String IMS_TAXANS){
        this.IMS_TAXANS = IMS_TAXANS;
        }
        ...
        public String getO_TAX_FROM_BRANCH(){
        return this.O_TAX_FROM_BRANCH;
        }
        public void setO_TAX_FROM_BRANCH(String O_TAX_FROM_BRANCH){
        this.O_TAX_FROM_BRANCH = O_TAX_FROM_BRANCH;
        }
...
public void parseCbsTele(String tita) throws ParseException{
        this.setIMS_TAXANS(EbcdicConverter.fromHex(CCSID.English,tita.substring(0, 16)));
        ...
        this.setO_TAX_FROM_BRANCH(EbcdicConverter.fromHex(CCSID.English,tita.substring(554, 568)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(568, 1200)));
}

public String makeMessage() {
return "" //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getIMS_TAXANS(), 8) //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getO_TAX_FROM_BRANCH(), 7) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 316) //
;
}

public String makeMessageAscii() {
return "" //
            + StringUtils.leftPad(this.getIMS_TAXANS(), 8," ") //
            ...
            + StringUtils.leftPad(this.getO_TAX_FROM_BRANCH(), 7," ") //
            + StringUtils.leftPad(this.getDRVS(), 316," ") //
;
}
}
