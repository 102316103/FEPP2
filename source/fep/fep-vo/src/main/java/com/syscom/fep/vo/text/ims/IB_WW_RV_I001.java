...
public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(780, 1200)));
}
...
return "" //
        ...
        + this.getPINBLOCK()  //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 210) //
;
}
...
return "" //
        ...
        + this.getPINBLOCK()  //
            ...
            + StringUtils.leftPad(this.getBIT36_TMSTAN1(), 8," ") //
            + StringUtils.leftPad(this.getDRVS(), 210," ") //
;
}
}
