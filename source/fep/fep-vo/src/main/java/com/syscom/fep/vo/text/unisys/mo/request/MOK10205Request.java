...
public class MOK10205Request extends MOUnisysTextBase {
    ...
    public String makeMessageFromGeneral(MOGeneral general) throws Exception {
        ...
        _SECNO = StringUtil.toHex(StringUtils.rightPad(tempVar.getSECNO(),2,' ')); //業務別
        ...
        _FILLER2 = StringUtil.toHex(StringUtils.leftPad("", 2, ' '));
