...
public class IB_PY_O011 extends IMSTextBase {
    @Field(length = 8)
	private String IMS_PYANS = StringUtils.EMPTY;
    ...
    @Field(length = 4)
	private String HOST_BRCH = StringUtils.EMPTY;

    @Field(length = 2)
	private String HOST_CHARGE = StringUtils.EMPTY;

    @Field(length = 1)
	private String CHARGE_FLAG = StringUtils.EMPTY;

    @Field(length = 13)
	private String TO_ACT = StringUtils.EMPTY;

    @Field(length = 303)
	private String DRVS = StringUtils.EMPTY;

	public String getIMS_PYANS(){
        return this.IMS_PYANS;
	}

	public void setIMS_PYANS(String IMS_PYANS){
        this.IMS_PYANS = IMS_PYANS;
	}
	...
	public String getHOST_BRCH(){
        return this.HOST_BRCH;
	}

	public void setHOST_BRCH(String HOST_BRCH){
        this.HOST_BRCH = HOST_BRCH;
	}

	public String getHOST_CHARGE(){
        return this.HOST_CHARGE;
	}

	public void setHOST_CHARGE(String HOST_CHARGE){
        this.HOST_CHARGE = HOST_CHARGE;
	}
	...
	public String getTO_ACT(){
        return this.TO_ACT;
	}

	public void setTO_ACT(String TO_ACT){
        this.TO_ACT = TO_ACT;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        this.setIMS_PYANS(EbcdicConverter.fromHex(CCSID.English,tita.substring(0, 16)));
        ...
        this.setAVAILABLE_BALANCE(EbcdicConverter.fromHex(CCSID.English,tita.substring(526, 554)));
        this.setHOST_BRCH(EbcdicConverter.fromHex(CCSID.English,tita.substring(554, 562)));
        this.setHOST_CHARGE(EbcdicConverter.fromHex(CCSID.English,tita.substring(562, 566)));
        this.setCHARGE_FLAG(EbcdicConverter.fromHex(CCSID.English,tita.substring(566, 568)));
        this.setTO_ACT(EbcdicConverter.fromHex(CCSID.English,tita.substring(568, 594)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(594, 1200)));
	}

	public String makeMessage() {
		return "" //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getIMS_PYANS(), 8) //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getHOST_BRCH(), 4) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getHOST_CHARGE(), 2) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getCHARGE_FLAG(), 1) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getTO_ACT(), 13) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 303) //
		;
	}

	public String makeMessageAscii() {
		return "" //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getIMS_PYANS(), StringUtils.EMPTY), 8," ") //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getO_TXN_TYPE_CODE(), StringUtils.EMPTY), 2," ") //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getO_FROM_BANK(), StringUtils.EMPTY), 3," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getO_FROM_ACT(), StringUtils.EMPTY), 16," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getO_TO_BANK(), StringUtils.EMPTY), 3," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getO_TO_ACT(), StringUtils.EMPTY), 16," ") //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getHOST_BRCH(), StringUtils.EMPTY), 4," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getHOST_CHARGE(), StringUtils.EMPTY), 2," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getCHARGE_FLAG(), StringUtils.EMPTY), 1," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getTO_ACT(), StringUtils.EMPTY), 13," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 303," ") //
		;
	}
}
