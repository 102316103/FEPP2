...
public class AB_PY_O001 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 4)
	private String PY_HOST_BRCH = StringUtils.EMPTY;

    @Field(length = 2)
	private BigDecimal PY_HOST_CHARGE;

    @Field(length = 1)
	private String PY_HOST_CHARGE_FLAG = StringUtils.EMPTY;

    @Field(length = 13)
	private String TO_ACT_006 = StringUtils.EMPTY;
	...
	public String getPY_HOST_BRCH(){
        return this.PY_HOST_BRCH;
	}

	public void setPY_HOST_BRCH(String PY_HOST_BRCH){
        this.PY_HOST_BRCH = PY_HOST_BRCH;
	}

	public BigDecimal getPY_HOST_CHARGE(){
        return this.PY_HOST_CHARGE;
	}

	public void setPY_HOST_CHARGE(BigDecimal PY_HOST_CHARGE){
		this.PY_HOST_CHARGE = PY_HOST_CHARGE;
	}

	public String getPY_HOST_CHARGE_FLAG(){
        return this.PY_HOST_CHARGE_FLAG;
	}

	public void setPY_HOST_CHARGE_FLAG(String PY_HOST_CHARGE_FLAG){
        this.PY_HOST_CHARGE_FLAG = PY_HOST_CHARGE_FLAG;
	}

	public String getTO_ACT_006(){
        return this.TO_ACT_006;
	}

	public void setTO_ACT_006(String TO_ACT_006){
        this.TO_ACT_006 = TO_ACT_006;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setPY_HOST_BRCH(EbcdicConverter.fromHex(CCSID.English,tita.substring(554, 562)));
        this.setPY_HOST_CHARGE(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English,tita.substring(562, 566).trim()), false, 0));
        this.setPY_HOST_CHARGE_FLAG(EbcdicConverter.fromHex(CCSID.English,tita.substring(566, 568)));
        this.setTO_ACT_006(EbcdicConverter.fromHex(CCSID.English,tita.substring(568, 594)));
	...
	public String makeMessage() {
		return "" //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPY_HOST_BRCH(), 4) //
            + CodeGenUtil.bigDecimalToEbcdic(this.getPY_HOST_CHARGE(), 2, false, 0, false) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPY_HOST_CHARGE_FLAG(), 1) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getTO_ACT_006(), 13) //
	...
	public String makeMessageAscii() {
		return "" //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getPY_HOST_BRCH(), StringUtils.EMPTY), 4," ") //
            + CodeGenUtil.bigDecimalToAsciiCBS(this.getPY_HOST_CHARGE(), 2, false, 0, false) //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getPY_HOST_CHARGE_FLAG(), StringUtils.EMPTY), 1," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getTO_ACT_006(), StringUtils.EMPTY), 13," ") //
