...
public class CB_FCA_O001 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 452)
	private String FRADATA = StringUtils.EMPTY;
	...
	public String getFRADATA(){
        return this.FRADATA;
	}

	public void setFRADATA(String FRADATA){
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setFRADATA(EbcdicConverter.fromHex(CCSID.English,tita.substring(204, 1108)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(1108, 1200)));
	}
	...
	public String makeMessage() {
		return "" //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getFRADATA(), 452) //
	...
	public String makeMessageAscii() {
		return "" //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getFRADATA(), StringUtils.EMPTY), 452," ") //
