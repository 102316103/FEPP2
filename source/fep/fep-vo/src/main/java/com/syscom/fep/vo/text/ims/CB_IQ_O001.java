...
public class CB_IQ_O001 extends IMSTextBase {
    @Field(length = 8)
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setE_CLEANBRANCHOUT(EbcdicConverter.fromHex(CCSID.English,tita.substring(554, 562)));
        this.setACTNAME(EbcdicConverter.fromHex(CCSID.English,tita.substring(562, 602)));
        this.setAUTHAMT(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English,tita.substring(602, 616).trim()), false, 0));
	...
	public String makeMessage() {
		return "" //
            ...
            + CodeGenUtil.bigDecimalToEbcdic(this.getAUTHAMT(), 6, false, 0, true) //
	...
	public String makeMessageAscii() {
		return "" //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getE_CLEANBRANCHOUT(), StringUtils.EMPTY), 4," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getACTNAME(), StringUtils.EMPTY), 20," ") //
            + CodeGenUtil.bigDecimalToAsciiCBS(this.getAUTHAMT(), 6, false, 0, true) //
