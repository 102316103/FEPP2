...
public class AB_TAX_O001 extends IMSTextBase {
    @Field(length = 8)
	...
	public String makeMessageAscii() {
		return "" //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getTAX_FROM_BRANCH(), StringUtils.EMPTY), 7," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getCLEANBRANCHOUT(), StringUtils.EMPTY), 4," ") //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 292," ") //
		;
	}
}
