...
public class AB_DP_O001 extends IMSTextBase {
    @Field(length = 8)
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setDPAMT(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English,tita.substring(578, 606).trim()), false, 2));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(606, 1200)));
	}
	...
	public String makeMessage() {
		return "" //
            ...
            + CodeGenUtil.bigDecimalToEbcdic(this.getDPAMT(), 11, false, 2, true) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 297) //
		;
	}
	...
	public String makeMessageAscii() {
		return "" //
            ...
            + CodeGenUtil.bigDecimalToAsciiCBS(this.getDPAMT(), 11, false, 2, true) //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 297," ") //
		;
	}
}
