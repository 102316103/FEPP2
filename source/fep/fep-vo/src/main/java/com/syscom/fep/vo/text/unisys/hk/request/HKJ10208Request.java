...
public class HKJ10208Request extends HKUnisysTextBase {
    //ATM代號
    @Field(length = 10)
    ...
    //香港卡的國際卡提領限額
    @Field(length = 18, optional = true)
    private String _A_PLUS_LMT = "";

    //
    @Field(length = 564, optional = true)
    ...
    /**
     ...
     <remark></remark>
     */
    public String getAPlusLmt() {
        return _A_PLUS_LMT;
    }
    public void setAPlusLmt(String value) {
        _A_PLUS_LMT = value;
    }
    /**
