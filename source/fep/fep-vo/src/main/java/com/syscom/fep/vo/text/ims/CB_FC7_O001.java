...
public class CB_FC7_O001 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 170)
	private String FR7DATA = StringUtils.EMPTY;
	...
	public String getFR7DATA(){
        return this.FR7DATA;
	}

	public void setFR7DATA(String FR7DATA){
        this.FR7DATA = FR7DATA;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setFR7DATA(EbcdicConverter.fromHex(CCSID.English,tita.substring(204, 544)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(544, 1200)));
	}
	...
	public String makeMessage() {
		return "" //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getFR7DATA(), 170) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 328) //
		;
	}
	...
	public String makeMessageAscii() {
		return "" //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getFR7DATA(), StringUtils.EMPTY), 170," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 328," ") //
		;
	}
}
