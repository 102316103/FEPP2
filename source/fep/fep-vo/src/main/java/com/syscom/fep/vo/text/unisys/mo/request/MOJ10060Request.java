...
public class MOJ10060Request extends MOUnisysTextBase {
    //ATM代號
    @Field(length = 10)
    ...
    private static final int _TotalLength = 779;
    ...
    public void setRemarkM(String value) {
        _REMARK_M = value;
    }
    /**
     業務別
    ...
    public String makeMessageFromGeneral(MOGeneral general) throws Exception {
        ...
        _REMARK = StringUtil.toHex(StringUtils.rightPad(tempVar.getREMARK(),16,' ')); //轉入帳號
        _REMARK_M = StringUtil.toHex(StringUtils.rightPad(tempVar.getRemarkM(),16,' ')); //轉出帳號
