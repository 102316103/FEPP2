...
public class IB_TR_I012 extends IMSTextBase {
    @Field(length = 8)
...
public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setTXMEMO(EbcdicConverter.fromHex(CCSID.English,tita.substring(504, 584)));
        this.setI_ACT_BIT57(EbcdicConverter.fromHex(CCSID.English,tita.substring(584, 608)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(608, 1200)));
}
...
return "" //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 296) //
;
}
...
return "" //
            ...
            + StringUtils.leftPad(this.getTR_SPECIAL_FLAG(), 2," ") //
            + StringUtils.leftPad(this.getTXMEMO(), 40," ") //
            + StringUtils.leftPad(this.getI_ACT_BIT57(), 12," ") //
            + StringUtils.leftPad(this.getDRVS(), 296," ") //
;
}
}
