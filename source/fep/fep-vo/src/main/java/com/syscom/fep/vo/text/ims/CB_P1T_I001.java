...
public class CB_P1T_I001 extends IMSTextBase {
    @Field(length = 8)
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setPIEPIN(EbcdicConverter.fromHex(CCSID.English,tita.substring(440, 472)));
        this.setPIPTRIES(EbcdicConverter.fromHex(CCSID.English,tita.substring(472, 476)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(476, 1200)));
	}
	...
	public String makeMessage() {
        ...
        + this.getPIEPIN()  //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 362) //
		;
	}
	...
	public String makeMessageAscii() {
        ...
        + this.getPIEPIN()  //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 362," ") //
		;
	}
}
