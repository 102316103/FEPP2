...
public class CB_FC9_O001 extends IMSTextBase {
    @Field(length = 8)
	...
	public void setD0DATA(String D0DATA){
        this.D0DATA = D0DATA;
	}
	...
	public void setFR9DATA(String FR9DATA){
        this.FR9DATA = FR9DATA;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setD0DATA(EbcdicConverter.fromHex(CCSID.English,tita.substring(204, 280)));
		this.setFR9DATA(tita.substring(280, 1096));
        this.setS1(EbcdicConverter.fromHex(CCSID.English,tita.substring(1096, 1100)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(1100, 1200)));
	}
	...
	public String makeMessage() {
		return "" 
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getD0DATA(), 38) 
        	+ this.getFR9DATA()  
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getS1(), 2) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 50) 
		;
	}
	...
	public String makeMessageAscii() {
		return "" 
			...
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getD0DATA(), StringUtils.EMPTY), 38," ")
        	+ this.getFR9DATA()  
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getS1(), StringUtils.EMPTY), 2," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 50," ")
		;
	}
}
