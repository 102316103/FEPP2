...
public class AB_WD_O001 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 12)
	private String FWDTMEX_NO = StringUtils.EMPTY;

    @Field(length = 7)
	private String AUTH_AMT = StringUtils.EMPTY;
	...
	public String getFWDTMEX_NO(){
        return this.FWDTMEX_NO;
	}

	public void setFWDTMEX_NO(String FWDTMEX_NO){
        this.FWDTMEX_NO = FWDTMEX_NO;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setFWDTMEX_NO(EbcdicConverter.fromHex(CCSID.English,tita.substring(526, 550)));
        this.setAUTH_AMT(EbcdicConverter.fromHex(CCSID.English,tita.substring(550, 564)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(564, 1200)));
	}
	...
	public String makeMessage() {
		return "" //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getFWDTMEX_NO(), 12) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getAUTH_AMT(), 7) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 318) //
		;
	}
	...
	public String makeMessageAscii() {
		return "" //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getFWDTMEX_NO(), StringUtils.EMPTY), 12," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getAUTH_AMT(), StringUtils.EMPTY), 7," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 318," ") //
		;
	}
}
