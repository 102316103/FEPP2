...
public class AB_VA_O001 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 10)
    private String TAXIDNO = StringUtils.EMPTY;

    @Field(length = 2)
    private String AEIPYUSE = StringUtils.EMPTY;
    ...
    @Field(length = 1)
    private String MNO_CHANGE = StringUtils.EMPTY;
    ...
    public String getAEIPYUSE() {
        return this.AEIPYUSE;
    }

    public void setAEIPYUSE(String AEIPYUSE) {
        this.AEIPYUSE = AEIPYUSE;
    }
    ...
    public String getMNO_CHANGE() {
        return this.MNO_CHANGE;
    }

    public void setMNO_CHANGE(String MNO_CHANGE) {
        this.MNO_CHANGE = MNO_CHANGE;
    }
    ...
    public void parseCbsTele(String tita) throws ParseException {
        ...
        this.setAEIPYTP(EbcdicConverter.fromHex(CCSID.English, tita.substring(494, 496)));
        this.setPAYUNTNO(EbcdicConverter.fromHex(CCSID.English, tita.substring(496, 512)));
        this.setTAXTYPE(EbcdicConverter.fromHex(CCSID.English, tita.substring(512, 522)));
        this.setPAYFEENO(EbcdicConverter.fromHex(CCSID.English, tita.substring(522, 530)));
        this.setTAXIDNO(EbcdicConverter.fromHex(CCSID.English, tita.substring(530, 550)));
        this.setAEIPYUSE(EbcdicConverter.fromHex(CCSID.English, tita.substring(550, 554)));
        this.setAELFTP(EbcdicConverter.fromHex(CCSID.English, tita.substring(554, 558)));
        this.setAEILFRC1(EbcdicConverter.fromHex(CCSID.English, tita.substring(562, 566)));
        this.setAEILFRC2(EbcdicConverter.fromHex(CCSID.English, tita.substring(558, 562)));
        this.setOPENACT(EbcdicConverter.fromHex(CCSID.English, tita.substring(566, 570)));
        this.setMNO_CHANGE(EbcdicConverter.fromHex(CCSID.English, tita.substring(570, 572)));
    ...
    public String makeMessage() {
        return "" //
                ...
                + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getAEIPYTP(), 1) //
                ...
                + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getTAXIDNO(), 10) //
                + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getAEIPYUSE(), 2) //
                ...
                + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getMNO_CHANGE(), 1) //
    ...
    public String makeMessageAscii() {
        return "" //
                ...
                + StringUtils.leftPad(this.getAEIPYTP(), 1, " ") //
                + StringUtils.leftPad(this.getPAYUNTNO(), 8, " ") //
                + StringUtils.leftPad(this.getTAXTYPE(), 5, " ") //
                + StringUtils.leftPad(this.getPAYFEENO(), 4, " ") //
                + StringUtils.leftPad(this.getTAXIDNO(), 10, " ") //
                + StringUtils.leftPad(this.getAEIPYUSE(), 2, " ") //
                + StringUtils.leftPad(this.getAELFTP(), 2, " ") //
                + StringUtils.leftPad(this.getAEILFRC1(), 2, " ") //
                + StringUtils.leftPad(this.getAEILFRC2(), 2, " ") //
                + StringUtils.leftPad(this.getOPENACT(), 2, " ") //
                + StringUtils.leftPad(this.getMNO_CHANGE(), 1, " ") //
