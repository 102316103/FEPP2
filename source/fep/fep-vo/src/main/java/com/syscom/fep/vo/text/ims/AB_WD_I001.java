...
public class AB_WD_I001 extends IMSTextBase {
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setPINBLOCK(EbcdicConverter.fromHex(CCSID.English,tita.substring(520, 552)));
        this.setEXCHANGE_RATE(EbcdicConverter.fromHex(CCSID.English,tita.substring(552, 568)));
        this.setCUSTOMER_NATIONTYPE(EbcdicConverter.fromHex(CCSID.English,tita.substring(568, 570)));
        this.setFCWDAMT(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English,tita.substring(570, 592).trim()), false, 2));
        this.setCUSTOMER_ID(EbcdicConverter.fromHex(CCSID.English,tita.substring(592, 612)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(612, 1296)));
	}
	...
	public String makeMessage() {
        ...
        + this.getPINBLOCK()  //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 342) //
		;
	}
	...
	public String makeMessageAscii() {
        ...
        + this.getPINBLOCK()  //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 342," ") //
		;
	}
}
