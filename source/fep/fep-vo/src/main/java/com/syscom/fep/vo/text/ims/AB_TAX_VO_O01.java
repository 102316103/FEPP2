...
public class AB_TAX_VO_O01 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 7)
    private String TAX_FROM_BRANCH = StringUtils.EMPTY;

    @Field(length = 4)
    private String CLEANBRANCHOUT = StringUtils.EMPTY;

    @Field(length = 4)
    private String CHAFEE_BRANCH = StringUtils.EMPTY;

    @Field(length = 2)
    private BigDecimal CHAFEEAMT;
    ...
    public String getTAX_FROM_BRANCH(){
        return this.TAX_FROM_BRANCH;
    }

    public void setTAX_FROM_BRANCH(String TAX_FROM_BRANCH){
        this.TAX_FROM_BRANCH = TAX_FROM_BRANCH;
    }
    ...
    public void setCLEANBRANCHOUT(String CLEANBRANCHOUT){
        this.CLEANBRANCHOUT = CLEANBRANCHOUT;
    }
    ...
    public BigDecimal getCHAFEEAMT(){
        return this.CHAFEEAMT;
    }

    public void setCHAFEEAMT(BigDecimal CHAFEEAMT){
        this.CHAFEEAMT = CHAFEEAMT;
    }
    ...
    public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setAVAILABLE_BALANCE(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English,tita.substring(526, 554).trim()), false, 2));
        this.setTAX_FROM_BRANCH(EbcdicConverter.fromHex(CCSID.English,tita.substring(554, 568)));
        this.setCLEANBRANCHOUT(EbcdicConverter.fromHex(CCSID.English,tita.substring(568, 576)));
        this.setCHAFEE_BRANCH(EbcdicConverter.fromHex(CCSID.English,tita.substring(576, 584)));
        this.setCHAFEEAMT(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English,tita.substring(584, 588).trim()), false, 0));
        this.setTRANSAMTOUT(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English,tita.substring(588, 616).trim()), false, 2));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(616, 1200)));
    }
    ...
    public String makeMessage() {
        return "" //
                ...
                + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getTAX_FROM_BRANCH(), 7) //
                + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getCLEANBRANCHOUT(), 4) //
                + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getCHAFEE_BRANCH(), 4) //
                + CodeGenUtil.bigDecimalToEbcdic(this.getCHAFEEAMT(), 2, false, 0, false) //
                + CodeGenUtil.bigDecimalToEbcdic(this.getTRANSAMTOUT(), 11, false, 2, true) //
                + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 292) //
                ;
    }
    ...
    public String makeMessageAscii() {
        return "" //
                ...
                + StringUtils.rightPad(this.getIMSRC4_FISC(), 4," ") //
                + StringUtils.rightPad(this.getIMSRC_TCB(), 3," ") //
                + StringUtils.rightPad(this.getIMSBUSINESS_DATE(), 7," ") //
                + StringUtils.rightPad(this.getIMSACCT_FLAG(), 1," ") //
                + StringUtils.rightPad(this.getIMSRVS_FLAG(), 1," ") //
                + StringUtils.rightPad(this.getIMS_TXN_TIME(), 6," ") //
                + StringUtils.rightPad(this.getIMS_OUT_STAN(), 10," ") //
                + StringUtils.rightPad(this.getIMS_FMMBR(), 4," ") //
                + StringUtils.rightPad(this.getIMS_TMMBR(), 4," ") //
                + StringUtils.rightPad(this.getHRVS(), 20," ") //
                + StringUtils.rightPad(this.getIMS_MAC(), 4," ") //
                + StringUtils.rightPad(this.getNOTICE_TYPE(), 1," ") //
                + StringUtils.rightPad(this.getNOTICE_NUMBER(), 3," ") //
                + StringUtils.rightPad(this.getNOTICE_CUSID(), 10," ") //
                + StringUtils.rightPad(this.getNOTICE_MOBILENO(), 10," ") //
                + StringUtils.rightPad(this.getNOTICE_EMAIL(), 50," ") //
                + StringUtils.rightPad(this.getSEND_FISC2160(), 1," ") //
                + StringUtils.rightPad(this.getTXNTYPE_CODE(), 2," ") //
                ...
                + StringUtils.rightPad(this.getFROMBANK(), 3," ") //
                + StringUtils.rightPad(this.getFROMACT(), 16," ") //
                + StringUtils.rightPad(this.getTOBANK(), 3," ") //
                + StringUtils.rightPad(this.getTOACT(), 16," ") //
                + CodeGenUtil.bigDecimalToAsciiCBS(this.getACTBALANCE(), 11, false, 2, true) //
                + StringUtils.rightPad(this.getLUCKYNO(), 16," ") //
                + CodeGenUtil.bigDecimalToAsciiCBS(this.getAVAILABLE_BALANCE(), 11, false, 2, true) //
                + StringUtils.rightPad(this.getTAX_FROM_BRANCH(), 7," ") //
                + StringUtils.rightPad(this.getCLEANBRANCHOUT(), 4," ") //
                + StringUtils.rightPad(this.getCHAFEE_BRANCH(), 4," ") //
                + CodeGenUtil.bigDecimalToAsciiCBS(this.getCHAFEEAMT(), 2, false, 0, false) //
                + CodeGenUtil.bigDecimalToAsciiCBS(this.getTRANSAMTOUT(), 11, false, 2, true) //
                + StringUtils.rightPad(this.getDRVS(), 292," ") //
                ;
    }
}
