...
public class AB_WW_I001 extends IMSTextBase {
    @Field(length = 8)
	...
	public void setEMVAUTH(String EMVAUTH){
        this.EMVAUTH = EMVAUTH;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setEMVCARD(EbcdicConverter.fromHex(CCSID.English,tita.substring(440, 478)));
        this.setPIPOSENT(EbcdicConverter.fromHex(CCSID.English,tita.substring(478, 486)));
        this.setPITK2FRM(EbcdicConverter.fromHex(CCSID.English,tita.substring(486, 488)));
        this.setEMVAUTH(EbcdicConverter.fromHex(CCSID.English,tita.substring(488, 500)));
	...
	public String makeMessage() {
        ...
        + this.getTXNICCTAC()  //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPIPOSENT(), 4) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPITK2FRM(), 1) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getEMVAUTH(), 6) //
	...
	public String makeMessageAscii() {
        ...
        + this.getTXNICCTAC()  //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getPIPOSENT(), StringUtils.EMPTY), 4," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getPITK2FRM(), StringUtils.EMPTY), 1," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getEMVAUTH(), StringUtils.EMPTY), 6," ") //
