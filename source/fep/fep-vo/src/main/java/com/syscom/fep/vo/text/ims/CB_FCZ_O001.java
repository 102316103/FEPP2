...
public class CB_FCZ_O001 extends IMSTextBase {
    @Field(length = 8)
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setTXNTYPE_CODE(EbcdicConverter.fromHex(CCSID.English,tita.substring(204, 208)));
        this.setFROMBANK(EbcdicConverter.fromHex(CCSID.English,tita.substring(208, 214)));
        this.setFROMACT(EbcdicConverter.fromHex(CCSID.English,tita.substring(214, 246)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(246, 1200)));
	}
	...
	public String makeMessage() {
		return "" //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 477) //
		;
	}
	...
	public String makeMessageAscii() {
		return "" //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 477," ") //
		;
	}
}
