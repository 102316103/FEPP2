...
public class CB_FC2_O001 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 3)
        private String R0_LENTH = StringUtils.EMPTY;
    ...
    @Field(length = 3)
        private String FR2_ACTDAT_LEN = StringUtils.EMPTY;

    @Field(length = 480)
        private String FR2_ACTDATA = StringUtils.EMPTY;
    ...
    @Field(length = 8)
        ...
        public String getR0_LENTH(){
        return this.R0_LENTH;
        }
        public void setR0_LENTH(String R0_LENTH){
        this.R0_LENTH = R0_LENTH;
        }
        ...
        public String getFR2_ACTDAT_LEN(){
        return this.FR2_ACTDAT_LEN;
        }
        public void setFR2_ACTDAT_LEN(String FR2_ACTDAT_LEN){
        this.FR2_ACTDAT_LEN = FR2_ACTDAT_LEN;
        }
        public String getFR2_ACTDATA(){
        return this.FR2_ACTDATA;
        }
        public void setFR2_ACTDATA(String FR2_ACTDATA){
        this.FR2_ACTDATA = FR2_ACTDATA;
        }
...
public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setR0_LENTH(EbcdicConverter.fromHex(CCSID.English,tita.substring(204, 210)));
        this.setACT_COUNT(EbcdicConverter.fromHex(CCSID.English,tita.substring(210, 214)));
        this.setACT_LENGTH(EbcdicConverter.fromHex(CCSID.English,tita.substring(214, 218)));
        this.setFR2_ACTDAT_LEN(EbcdicConverter.fromHex(CCSID.English,tita.substring(218, 224)));
        this.setFR2_ACTDATA(EbcdicConverter.fromHex(CCSID.English,tita.substring(224, 1184)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(1184, 1200)));
}
...
return "" //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getR0_LENTH(), 3) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getACT_COUNT(), 2) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getACT_LENGTH(), 2) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getFR2_ACTDAT_LEN(), 3) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getFR2_ACTDATA(), 480) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 8) //
;
}
...
return "" //
            ...
            + StringUtils.leftPad(this.getR0_LENTH(), 3," ") //
            + StringUtils.leftPad(this.getACT_COUNT(), 2," ") //
            + StringUtils.leftPad(this.getACT_LENGTH(), 2," ") //
            + StringUtils.leftPad(this.getFR2_ACTDAT_LEN(), 3," ") //
            + StringUtils.leftPad(this.getFR2_ACTDATA(), 480," ") //
            + StringUtils.leftPad(this.getDRVS(), 8," ") //
;
}
}
