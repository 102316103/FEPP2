...
public class IB_WD_TR_O001 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 4)
	private String ACTIVITY_TYPE = StringUtils.EMPTY;
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setACTIVITY_TYPE(EbcdicConverter.fromHex(CCSID.English,tita.substring(474, 482)));
        this.setFROM_ACT(EbcdicConverter.fromHex(CCSID.English,tita.substring(482, 508)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(508, 1200)));
	}
	...
	public String makeMessage() {
		return "" //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getACTIVITY_TYPE(), 4) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getFROM_ACT(), 13) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 346) //
		;
	}
	...
	public String makeMessageAscii() {
		return "" //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getACTIVITY_TYPE(), StringUtils.EMPTY), 4," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getFROM_ACT(), StringUtils.EMPTY), 13," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 346," ") //
		;
	}
}
