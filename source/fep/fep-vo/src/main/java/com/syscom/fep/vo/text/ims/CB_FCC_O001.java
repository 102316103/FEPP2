...
public class CB_FCC_O001 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 34)
	private String D0_FCC = StringUtils.EMPTY;
	...
	public String getD0_FCC(){
        return this.D0_FCC;
	}

	public void setD0_FCC(String D0_FCC){
        this.D0_FCC = D0_FCC;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setD0_FCC(EbcdicConverter.fromHex(CCSID.English,tita.substring(204, 272)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(272, 1200)));
	}
	...
	public String makeMessage() {
		return "" //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getD0_FCC(), 34) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 464) //
		;
	}
	...
	public String makeMessageAscii() {
		return "" //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getD0_FCC(), StringUtils.EMPTY), 34," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 464," ") //
		;
	}
}
