...
public class CB_FC1_O001 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 7)
	private String ERRPGM = StringUtils.EMPTY;

    @Field(length = 1)
	private String PBMCRD = StringUtils.EMPTY;
	...
	public String getERRPGM(){
        return this.ERRPGM;
	}

	public void setERRPGM(String ERRPGM){
        this.ERRPGM = ERRPGM;
	}

	public String getPBMCRD(){
        return this.PBMCRD;
	}

	public void setPBMCRD(String PBMCRD){
        this.PBMCRD = PBMCRD;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setERRPGM(EbcdicConverter.fromHex(CCSID.English,tita.substring(526, 540)));
        this.setPBMCRD(EbcdicConverter.fromHex(CCSID.English,tita.substring(540, 542)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(542, 1200)));
	}
	...
	public String makeMessage() {
		return "" //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getERRPGM(), 7) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPBMCRD(), 1) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 329) //
		;
	}
	...
	public String makeMessageAscii() {
		return "" //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getERRPGM(), StringUtils.EMPTY), 7," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getPBMCRD(), StringUtils.EMPTY), 1," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 329," ") //
		;
	}
}
