...
public class IB_TR_O011 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 12)
	private String O_TR_BIT57 = StringUtils.EMPTY;

    @Field(length = 14)
	private String AVAILABLE_BALANCE = StringUtils.EMPTY;

    @Field(length = 4)
	private String AEHOBRMR = StringUtils.EMPTY;
	...
	public String getO_TR_BIT57(){
        return this.O_TR_BIT57;
	}

	public void setO_TR_BIT57(String O_TR_BIT57){
        this.O_TR_BIT57 = O_TR_BIT57;
	}
	...
	public String getAEHOBRMR(){
        return this.AEHOBRMR;
	}

	public void setAEHOBRMR(String AEHOBRMR){
        this.AEHOBRMR = AEHOBRMR;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setO_TR_BIT57(EbcdicConverter.fromHex(CCSID.English,tita.substring(526, 550)));
        this.setAVAILABLE_BALANCE(EbcdicConverter.fromHex(CCSID.English,tita.substring(550, 578)));
        this.setAEHOBRMR(EbcdicConverter.fromHex(CCSID.English,tita.substring(578, 586)));
        this.setTO_ACT(EbcdicConverter.fromHex(CCSID.English,tita.substring(586, 612)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(612, 1200)));
	}
	...
	public String makeMessage() {
		return "" //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getO_TR_BIT57(), 12) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getAVAILABLE_BALANCE(), 14) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getAEHOBRMR(), 4) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getTO_ACT(), 13) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 294) //
		;
	}
	...
	public String makeMessageAscii() {
		return "" //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getO_TR_BIT57(), StringUtils.EMPTY), 12," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getAVAILABLE_BALANCE(), StringUtils.EMPTY), 14," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getAEHOBRMR(), StringUtils.EMPTY), 4," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getTO_ACT(), StringUtils.EMPTY), 13," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 294," ") //
		;
	}
}
