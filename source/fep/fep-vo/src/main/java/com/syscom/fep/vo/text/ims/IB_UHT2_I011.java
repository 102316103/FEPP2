...
public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(560, 1200)));
}
...
return "" //
        ...
        + this.getTXNICCTAC()  //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 320) //
;
}
...
return "" //
        ...
        + this.getTXNICCTAC()  //
            ...
            + StringUtils.leftPad(this.getUH_Bill_No(), 16," ") //
            + StringUtils.leftPad(this.getUH_Merchant_ID(), 30," ") //
            + StringUtils.leftPad(this.getUH_ORG_STAN(), 10," ") //
            + StringUtils.leftPad(this.getUH_Reason_Code(), 2," ") //
            + StringUtils.leftPad(this.getUH_special_flag(), 2," ") //
            + StringUtils.leftPad(this.getDRVS(), 320," ") //
;
}
}
