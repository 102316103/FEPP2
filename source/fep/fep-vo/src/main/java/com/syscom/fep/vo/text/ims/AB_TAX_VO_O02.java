...
public class AB_TAX_VO_O02 extends IMSTextBase {
    @Field(length = 8)
    ...
    public void parseCbsTele(String tita) throws ParseException {
        ...
        this.setOVTXC(EbcdicConverter.fromHex(CCSID.English, tita.substring(568, 584)));
        this.setOVBHI(EbcdicConverter.fromHex(CCSID.English, tita.substring(584, 592)));
        this.setOVTLI(EbcdicConverter.fromHex(CCSID.English, tita.substring(592, 596)));
        this.setOVSEQ(EbcdicConverter.fromHex(CCSID.English, tita.substring(596, 608)));
        this.setOVTRMNO(EbcdicConverter.fromHex(CCSID.English, tita.substring(608, 630)));
        this.setOVOPR(EbcdicConverter.fromHex(CCSID.English, tita.substring(630, 634)));
        this.setOVCTL(EbcdicConverter.fromHex(CCSID.English, tita.substring(634, 636)));
        this.setOVCGFEE(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English, tita.substring(636, 640).trim()), false, 0));
        this.setOVFAXNO(EbcdicConverter.fromHex(CCSID.English, tita.substring(640, 660)));
        this.setOVNAME(EbcdicConverter.fromHex(CCSID.English, tita.substring(660, 744)));
        this.setOVSEXF(EbcdicConverter.fromHex(CCSID.English, tita.substring(744, 746)));
        this.setOVTPT(EbcdicConverter.fromHex(CCSID.English, tita.substring(746, 748)));
        this.setOVEND(EbcdicConverter.fromHex(CCSID.English, tita.substring(748, 762)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English, tita.substring(762, 1200)));
    }
    ...
    public String makeMessage() {
        return "" //
                ...
                + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 219) //
                ;
    }
    ...
    public String makeMessageAscii() {
        return "" //
                ...
                + StringUtils.leftPad(this.getTAX_FROM_BRANCH(), 7, " ") //
                ...
                + StringUtils.leftPad(this.getDRVS(), 219, " ") //
                ;
    }
}
