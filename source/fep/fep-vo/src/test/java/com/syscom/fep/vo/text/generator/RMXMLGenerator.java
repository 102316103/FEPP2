 ...
 * @author Richard
 */
public class RMXMLGenerator {
    private LogHelper logger = LogHelperFactory.getUnitTestLogger();
    private static final String BASE_PATH_SOURCE = "E:\\FEP\\documents\\FEP_Recent\\20221122_Codegen\\RM電文\\";
    ...
    private static final String BASE_PATH_TARGE = "E:\\FEP\\documents\\FEP_Recent\\20221122_Codegen\\RM電文\\Target\\";
    ...
    private static final String PACKAGE_RM = "com.syscom.fep.vo.text.rm";
    ...
    private static final String HEADER_REQUEST_CLASS_NAME = "RMHeaderRequest";
    private static final String HEADER_RESPONSE_CLASS_NAME = "RMHeaderResponse";
