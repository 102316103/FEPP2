...
public class EOIControllerTest extends ServerBaseTest {
	@Autowired
	private MockMvc mockMvc;

	@BeforeAll
	public void setup() throws Exception {
		SpringBeanFactoryUtil.registerController(NBController.class);
	}

	@AfterAll
	public void tearDown() throws Exception {
		SpringBeanFactoryUtil.unregisterBean(NBController.class);
	}
	...
	public void testVAA2566ForVAIssueRequestA() throws Exception {
		String messageXml = "<?xml version=\"1.0\" encoding=\"utf-8\"?>" +
				...
				"		<ChlEJNo>" + UUID.randomUUID().toString() + "</ChlEJNo>" +
				"		<ChlSendTime>" + FormatUtil.dateTimeFormat(Calendar.getInstance(), FormatUtil.FORMAT_DATE_YYYYMMDD_T_HHMMSSSSS) + "</ChlSendTime>" +
				"		<TxnID>ApplyBiz</TxnID>" +
				...
				"			<BRANCH>888</BRANCH>" +
				"			<BKNO>806</BKNO>" +
				"			<TXACT>0020152000030907</TXACT>" +
				"			<MODE>1</MODE>" +
				"			<VATYPE>01</VATYPE>" +
				"			<VAITEM>12</VAITEM>" +
				"			<IDNO>W112233449</IDNO>" +
				"			<MOBILE>0911223344</MOBILE>" +
				"			<BIRTHDAY>19550101</BIRTHDAY>" +
				"			<HPHONE/>" +
				"			<DEPT>R64000</DEPT>" +
				"		</Rq>" +
				"	</SvcRq>" +
