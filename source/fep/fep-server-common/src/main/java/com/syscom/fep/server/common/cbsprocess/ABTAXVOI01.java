...
import com.syscom.fep.vo.text.ims.AB_TAX_VO_I01;
import com.syscom.fep.vo.text.ims.AB_TAX_VO_O01;
import com.syscom.fep.vo.text.ims.AB_TAX_VO_O02;
...
public class ABTAXVOI01 extends ACBSAction {

    public ABTAXVOI01(MessageBase txData) {
        super(txData, new AB_TAX_VO_I01());
    }
...
//    private SmsmsgExtMapper smsmsgExtMapper = SpringBeanFactoryUtil.getBean(SmsmsgExtMapper.class);
    ...
    public FEPReturnCode getCbsTita(String txType) throws Exception {
        /* TITA 請參考合庫主機電文規格(AB_TAX_VO_I01) */
        // Header
        AB_TAX_VO_I01 cbstita = new AB_TAX_VO_I01();
        ...
        if (ATMTXCD.T6.name().equals(feptxn.getFeptxnTxCode())) {
            cbstita.setTAX_END_DATE(feptxn.getFeptxnDueDate());
            cbstita.setTAX_BILL_NO(feptxn.getFeptxnReconSeqno());
        } else if (ATMTXCD.T5.name().equals(feptxn.getFeptxnTxCode())) {
    ...
    public FEPReturnCode processCbsTota(String cbsTota, String type) throws Exception {
        /* 拆解主機回應電文 */
        AB_TAX_VO_O01 tota = new AB_TAX_VO_O01();
     ...
     * @throws Exception
     */
    private FEPReturnCode updateFEPTxn(AB_TAX_VO_O01 cbsTota) throws Exception {
     ...
     */
    private void insertSMSMSG(AB_TAX_VO_O01 cbsTota) throws ParseException {
...
//        }
    ...
    private void insertSMSMSG(AB_TAX_VO_O02 cbsTota) throws ParseException {
//        String txDate = feptxn.getFeptxnTxDate();
//        Integer ejfno = feptxn.getFeptxnEjfno();
//        Smsmsg smsmsg = smsmsgExtMapper.selectByPrimaryKey(txDate, ejfno);
//        // 檢核SMSMSG 資料是否存在，不存在才insert SMSMSG
