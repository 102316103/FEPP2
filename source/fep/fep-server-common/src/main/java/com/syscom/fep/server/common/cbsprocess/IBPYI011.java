...
//    private SmsmsgExtMapper smsmsgExtMapper = SpringBeanFactoryUtil.getBean(SmsmsgExtMapper.class);
    ...
    public FEPReturnCode getCbsTita(String txType) throws Exception {
        ...
        if (("2561".equals(feptxn.getFeptxnPcode()) || "2562".equals(feptxn.getFeptxnPcode())
                || "2563".equals(feptxn.getFeptxnPcode()) || "2654".equals(feptxn.getFeptxnPcode()))
                ...
                && "99991231".equals(feptxn.getFeptxnDueDate())) { //繳費期限: 99991231
        ...
        if(StringUtils.isNotBlank(feptxn.getFeptxnReconSeqno())){
