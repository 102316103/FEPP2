...
import com.syscom.fep.vo.text.ims.IB_PY_I012;
import com.syscom.fep.vo.text.ims.IB_PY_O012;
import org.apache.commons.lang3.StringUtils;

import java.util.Objects;

/**
 * 組送CBS 主機原存全國繳費Confirm交易電文
 * 
 * @author Joseph
 *
 */

public class IBPYI012 extends ACBSAction {

	public IBPYI012(MessageBase txData) {
		super(txData, new IB_PY_I012());
	}
...
//	private SmsmsgExtMapper smsmsgExtMapper = SpringBeanFactoryUtil.getBean(SmsmsgExtMapper.class);
	...
	public FEPReturnCode getCbsTita(String txType) throws Exception {
		...
		IB_PY_I012 cbsTita = new IB_PY_I012();
		// HEADER
	...
	public FEPReturnCode processCbsTota(String cbsTota, String type) throws Exception {
		/* 電文內容格式請參照TOTA電文格式(IB_PY_O012) */
		/* 拆解主機回應電文 */
		IB_PY_O012 tota = new IB_PY_O012();
	 ...
	 * @throws Exception
	 */
	private FEPReturnCode updateFEPTxn(IB_PY_O012 cbsTota, String type) throws Exception {
