...
//    private SmsmsgExtMapper smsmsgExtMapper = SpringBeanFactoryUtil.getBean(SmsmsgExtMapper.class);
    ...
    public FEPReturnCode getCbsTita(String txType) throws Exception {
        ...
        if ((FISCPCode.PCode2541.getValueStr().equals(feptxn.getFeptxnPcode())
                ...
                && this.getFiscData().getFiscreq().getTxnSourceInstituteId().substring(0, 2).equals("39") && this.getFiscData().getFiscreq().getTxnSourceInstituteId().substring(3, 7).equals("7999")
                && !this.getFiscData().getFiscreq().getTxnSourceInstituteId().equals("3997999")) {
