...
import com.syscom.fep.vo.text.ims.IB_TAX_I001;
import com.syscom.fep.vo.text.ims.IB_TAX_O001;
...
/**
 * 組送CBS 主機原存繳稅Request交易電文
 *
 * @author Joseph
 */

public class IBTAXI001 extends ACBSAction {

    public IBTAXI001(MessageBase txData) {
        super(txData, new IB_TAX_I001());
    }
...
//    private SmsmsgExtMapper smsmsgExtMapper = SpringBeanFactoryUtil.getBean(SmsmsgExtMapper.class);
    ...
    public FEPReturnCode getCbsTita(String txType) throws Exception {
        ...
        IB_TAX_I001 cbsTita = new IB_TAX_I001();
        // HEADER
        ...
        cbsTita.setDRVS(StringUtils.repeat(" ", 309)); // 保留欄位
    ...
    public FEPReturnCode processCbsTota(String cbsTota, String type) throws Exception {
        /* 電文內容格式請參照TOTA電文格式(IB_TAX_O001) */
        /* 拆解主機回應電文 */
        IB_TAX_O001 tota = new IB_TAX_O001();
     ...
     * @throws Exception
     */
    private FEPReturnCode updateFEPTxn(IB_TAX_O001 cbsTota, String type) throws Exception {
     ...
     */
    private void insertSMSMSG(IB_TAX_O001 cbsTota) throws ParseException {
