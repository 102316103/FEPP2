...
import com.syscom.fep.vo.text.ims.CB_FP_I001;
import com.syscom.fep.vo.text.ims.CB_FP_O001;
import org.apache.commons.lang3.StringUtils;

import java.util.Calendar;

/**
 * 組送CBS主機指靜脈密碼設定Request交易電文
 * 
 * @author Joseph
 *
 */

public class CBFPI001 extends ACBSAction {

	public CBFPI001(MessageBase txData) {
		super(txData, new CB_FP_O001());
	}
	...
	public FEPReturnCode getCbsTita(String txType) throws Exception {
		/* TITA 請參考合庫主機電文規格(CB_FP_I001) */
		// Header
		CB_FP_I001 cbstita = new CB_FP_I001();
		...
		cbstita.setPIEPIN(feptxn.getFeptxnPinblock()); //指靜脈密碼
	...
	public FEPReturnCode processCbsTota(String cbsTota, String type) throws Exception {
		/* 電文內容格式請參照TOTA電文格式(CB_FP_O001) */
		/* 拆解主機回應電文 */
		CB_FP_O001 tota = new CB_FP_O001();
	 ...
	 * @throws Exception
	 */
	private FEPReturnCode updateFEPTxn(CB_FP_O001 cbsTota) throws Exception {
