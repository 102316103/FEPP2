...
import com.syscom.fep.vo.text.ims.CB_DP_I001;

/**
 * 組送CBS主機自行存款Request交易電文
 *
 * @author Joseph
 *
 */

public class CBDPI001 extends ACBSAction {

	public CBDPI001(MessageBase txData) {
...
//	private SmsmsgExtMapper smsmsgExtMapper = SpringBeanFactoryUtil.getBean(SmsmsgExtMapper.class);
	...
	public FEPReturnCode getCbsTita(String txType) throws Exception {
		/* TITA 請參考合庫主機電文規格(CB_DP_I001) */
		// Header
		CB_DP_I001 cbstita = new CB_DP_I001();
		...
		if("D5".equals(feptxn.getFeptxnTxCode()) || "D6".equals(feptxn.getFeptxnTxCode())){
