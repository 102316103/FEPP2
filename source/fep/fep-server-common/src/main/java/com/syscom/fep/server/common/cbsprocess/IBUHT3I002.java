...
import com.syscom.fep.vo.text.ims.IB_UHT3_I002;
import com.syscom.fep.vo.text.ims.IB_UHT3_O002;
import org.apache.commons.lang3.StringUtils;

import java.util.Objects;

/**
 * 組送CBS 主機原存跨國消費扣款Confirm交易電文
 *
 * @author Joseph
 */

public class IBUHT3I002 extends ACBSAction {

    public IBUHT3I002(MessageBase txData) {
        super(txData, new IB_UHT3_I002());
    }
...
//    private SmsmsgExtMapper smsmsgExtMapper = SpringBeanFactoryUtil.getBean(SmsmsgExtMapper.class);
    ...
    public FEPReturnCode getCbsTita(String txType) throws Exception {
        ...
        IB_UHT3_I002 cbsTita = new IB_UHT3_I002();
        // HEADER
    ...
    public FEPReturnCode processCbsTota(String cbsTota, String type) throws Exception {
        /* 電文內容格式請參照TOTA電文格式(IB_UHT3_O002) */
        /* 拆解主機回應電文 */
        IB_UHT3_O002 tota = new IB_UHT3_O002();
     ...
     * @throws Exception
     */
    private FEPReturnCode updateFEPTxn(IB_UHT3_O002 cbsTota, String type) throws Exception {
