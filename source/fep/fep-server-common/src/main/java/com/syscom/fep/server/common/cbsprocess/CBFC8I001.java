...
import com.syscom.fep.vo.text.ims.CB_FC8_I001;
import com.syscom.fep.vo.text.ims.CB_FC8_O001;
...
public class CBFC8I001 extends ACBSAction {

	public CBFC8I001(MessageBase txData) {
		super(txData, new CB_FC8_O001());
	}
	...
	public FEPReturnCode getCbsTita(String txType) throws Exception {
		/* TITA 請參考合庫主機電文規格(CB_FC8_I001) */
		/* ATM.REQ 請參考 ATM_GeneralTrans */
		// Header
		CB_FC8_I001 cbstita = new CB_FC8_I001();
	...
	public FEPReturnCode processCbsTota(String cbsTota, String type) throws Exception {
		/* 電文內容格式請參照TOTA電文格式(CB_FC8_O001) */
		/* 拆解主機回應電文 */
		CB_FC8_O001 tota = new CB_FC8_O001();
	 ...
	 * @throws Exception
	 */
	private FEPReturnCode updateFEPTxn(CB_FC8_O001 cbsTota) throws Exception {
