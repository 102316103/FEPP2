...
import com.syscom.fep.vo.text.ims.CB_FD_I001;
import com.syscom.fep.vo.text.ims.CB_FD_O001;
 ...
 * 
 */
public class CBFDI001 extends ACBSAction {

	public CBFDI001(MessageBase txData) {
		super(txData, new CB_FD_O001());
	}
	...
	public FEPReturnCode getCbsTita(String txtype) throws Exception {
		/* TITA 請參考合庫主機電文規格(CB_FD_I001)*/
		/* ATM.REQ 請參考 ATM_GeneralTrans */
		CB_FD_I001 cbstita = new CB_FD_I001();
		...
		cbstita.setTOACT(atmReq.getTADATA().substring(0, 16)); // 前16位放刪除帳號
	...
	public FEPReturnCode processCbsTota(String cbsTota, String type) throws Exception {
		/* 電文內容格式請參照TOTA電文格式(CB_FD_O001) */
		CB_FD_O001 tota = new CB_FD_O001();
	 ...
	 * @throws Exception
	 */
	private FEPReturnCode updateFEPTxn(CB_FD_O001 cbsTota) throws Exception {
