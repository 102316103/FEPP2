...
import com.syscom.fep.vo.text.ims.CB_FC1_I001;
import com.syscom.fep.vo.text.ims.CB_FC1_O001;
...
public class CBFC1I001 extends ACBSAction {

	public CBFC1I001(MessageBase txData) {
		super(txData, new CB_FC1_O001());
	}
	...
	public FEPReturnCode getCbsTita(String txType) throws Exception {
		/* TITA 請參考合庫主機電文規格(CB_FC1_I001) */
		/* ATM.REQ 請參考 ATM_TRK2ChangeSSCode */
		// Header
		CB_FC1_I001 cbstita = new CB_FC1_I001();
		...
		cbstita.setFROMACT(StringUtils.substring(atmReq.getCARDPART1(), 6, 21)); // 卡片帳號
		cbstita.setPIEPIN(feptxn.getFeptxnPinblock()); // 密碼
	...
	public FEPReturnCode processCbsTota(String cbsTota, String type) throws Exception {
		/* 電文內容格式請參照TOTA電文格式(CB_FC1_O001) */
		/* 拆解主機回應電文 */
		CB_FC1_O001 tota = new CB_FC1_O001();
	 ...
	 * @throws Exception
	 */
	private FEPReturnCode updateFEPTxn(CB_FC1_O001 cbsTota) throws Exception {
