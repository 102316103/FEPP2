...
//    private SmsmsgExtMapper smsmsgExtMapper = SpringBeanFactoryUtil.getBean(SmsmsgExtMapper.class);
    ...
    public FEPReturnCode getCbsTita(String txType) throws Exception {
        ...
        cbsTita.setDRVS(StringUtils.repeat(" ", 206)); // 保留欄位
    ...
    private FEPReturnCode updateFEPTxn(IB_WW_O001 cbsTota, String type) throws Exception {
        ...
        if (FISCPCode.PCode2410.getValueStr().equals(feptxn.getFeptxnPcode())) {
            /* 2410 : 卡號轉換為實體帳號 */
            feptxn.setFeptxnTroutActno(cbsTota.getO_FROM_ACT());
        }
     ...
     */
    private void insertSMSMSG(IB_WW_O001 cbsTota) throws ParseException {
