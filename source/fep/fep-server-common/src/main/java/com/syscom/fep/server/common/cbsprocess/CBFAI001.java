...
import com.syscom.fep.vo.text.ims.CB_FA_I001;
import com.syscom.fep.vo.text.ims.CB_FA_O001;
 ...
 * 
 */
public class CBFAI001 extends ACBSAction {

	public CBFAI001(MessageBase txData) {
		super(txData, new CB_FA_O001());
	}
	...
	public FEPReturnCode getCbsTita(String txtype) throws Exception {
		/* TITA 請參考合庫主機電文規格(CB_FA_I001)*/
		/* ATM.REQ 請參考 ATM_GeneralTrans */
		CB_FA_I001 cbstita = new CB_FA_I001();
	...
	public FEPReturnCode processCbsTota(String cbsTota, String type) throws Exception {
		/* 電文內容格式請參照TOTA電文格式(CB_FA_O001) */
		CB_FA_O001 tota = new CB_FA_O001();
	 ...
	 * @throws Exception
	 */
	private FEPReturnCode updateFEPTxn(CB_FA_O001 cbsTota) throws Exception {
