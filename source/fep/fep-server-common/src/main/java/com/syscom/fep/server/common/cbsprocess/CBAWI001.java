...
import com.syscom.fep.vo.text.ims.CB_AW_I001;
import com.syscom.fep.vo.text.ims.CB_AW_O001;
import org.apache.commons.lang3.StringUtils;

import java.util.Calendar;

/**
 * 組送CBS主機無卡提款服務申請Request交易電文
 *
 * @author Joseph
 */

public class CBAWI001 extends ACBSAction {

    public CBAWI001(MessageBase txData) {
        super(txData, new CB_AW_O001());
    }
...
//    private SmsmsgExtMapper smsmsgExtMapper = SpringBeanFactoryUtil.getBean(SmsmsgExtMapper.class);
    ...
    public FEPReturnCode getCbsTita(String txType) throws Exception {
        /* TITA 請參考合庫主機電文規格(CB_AW_I001) */
        // Header
        CB_AW_I001 cbstita = new CB_AW_I001();
        ...
        cbstita.setPIAWMAC(atmReq.getSPECIALDATA().substring(0, 8)); //手機認證碼
    ...
    public FEPReturnCode processCbsTota(String cbsTota, String type) throws Exception {
        /* 電文內容格式請參照TOTA電文格式(CB_AW_O001) */
        /* 拆解主機回應電文 */
        CB_AW_O001 tota = new CB_AW_O001();
     ...
     * @throws Exception
     */
    private FEPReturnCode updateFEPTxn(CB_AW_O001 cbsTota) throws Exception {
