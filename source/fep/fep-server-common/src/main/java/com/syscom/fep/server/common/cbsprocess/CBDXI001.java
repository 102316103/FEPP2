...
import com.syscom.fep.vo.text.ims.CB_DX_I001;
import com.syscom.fep.vo.text.ims.CB_DX_O001;
import org.apache.commons.lang3.StringUtils;

import java.util.Calendar;

/**
 * 組送CBS主機自行無卡存款傳送簡訊驗證碼Request交易電文
 * 
 * @author Joseph
 *
 */

public class CBDXI001 extends ACBSAction {

	public CBDXI001(MessageBase txData) {
		super(txData, new CB_DX_O001());
	}
...
//	private SmsmsgExtMapper smsmsgExtMapper = SpringBeanFactoryUtil.getBean(SmsmsgExtMapper.class);
	...
	public FEPReturnCode getCbsTita(String txType) throws Exception {
		/* TITA 請參考合庫主機電文規格(CB_DX_I001) */
		// Header
		CB_DX_I001 cbstita = new CB_DX_I001();
		...
		cbstita.setPITELNO(atmReq.getSPECIALDATA().substring(0,10));
	...
	public FEPReturnCode processCbsTota(String cbsTota, String type) throws Exception {
		/* 電文內容格式請參照TOTA電文格式(CB_DX_O001) */
		/* 拆解主機回應電文 */
		CB_DX_O001 tota = new CB_DX_O001();
	 ...
	 * @throws Exception
	 */
	private FEPReturnCode updateFEPTxn(CB_DX_O001 cbsTota) throws Exception {
