...
import com.syscom.fep.vo.text.ims.IB_UHT1_I002;
import com.syscom.fep.vo.text.ims.IB_UHT1_O002;
import org.apache.commons.lang3.StringUtils;

import java.util.Objects;

/**
 * 組送CBS 主機原存消費扣款_固定費率Confirm交易電文
 *
 * @author Joseph
 */

public class IBUHT1I002 extends ACBSAction {

    public IBUHT1I002(MessageBase txData) {
        super(txData, new IB_UHT1_I002());
    }
...
//    private SmsmsgExtMapper smsmsgExtMapper = SpringBeanFactoryUtil.getBean(SmsmsgExtMapper.class);
    ...
    public FEPReturnCode getCbsTita(String txType) throws Exception {
        //組CBS 原存交易Request電文, 電文內容格式請參照: D_I6_T1合庫FEP_主機電文規格-原存行消費扣款固定(2525)V1.0(1111018).doc
        IB_UHT1_I002 cbsTita = new IB_UHT1_I002();
        // HEADER
        ...
        cbsTita.setTAX_TYPE(StringUtils.repeat(" ", 5)); // 繳款類
        cbsTita.setDRVS(StringUtils.repeat(" ", 343)); // 保留欄位
    ...
    public FEPReturnCode processCbsTota(String cbsTota, String type) throws Exception {
        /* 電文內容格式請參照TOTA電文格式(IB_UHT1_O002) */
        /* 拆解主機回應電文 */
        IB_UHT1_O002 tota = new IB_UHT1_O002();
     ...
     * @throws Exception
     */
    private FEPReturnCode updateFEPTxn(IB_UHT1_O002 cbsTota, String type) throws Exception {
