...
import com.syscom.fep.vo.text.ims.IB_UHT1_I001;
...
/**
 * 組送CBS 主機原存消費扣款_固定費率Request交易電文
 *
 * @author Joseph
 */

public class IBUHT1I001 extends ACBSAction {

    public IBUHT1I001(MessageBase txData) {
        super(txData, new IB_UHT1_I001());
    }
...
//    private SmsmsgExtMapper smsmsgExtMapper = SpringBeanFactoryUtil.getBean(SmsmsgExtMapper.class);
    ...
    public FEPReturnCode getCbsTita(String txType) throws Exception {
        //組CBS 原存交易Request電文, 電文內容格式請參照: D_I6_T1合庫FEP_主機電文規格-原存行消費扣款固定(2525)V1.0(1111018)
        IB_UHT1_I001 cbsTita = new IB_UHT1_I001();
        // HEADER
    ...
    public FEPReturnCode processCbsTota(String cbsTota, String type) throws Exception {
        /* 電文內容格式請參照TOTA電文格式(IB_UHT1_O001) */
        /* 拆解主機回應電文 */
        IB_UHT1_O001 tota = new IB_UHT1_O001();
     ...
     * @throws Exception
     */
    private FEPReturnCode updateFEPTxn(IB_UHT1_O001 cbsTota, String type) throws Exception {
    ...
    private void insertSMSMSG(IB_UHT1_O001 cbsTota) throws ParseException {
