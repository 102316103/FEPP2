...
import com.syscom.fep.vo.text.ims.IB_WD_TR_I002;
import com.syscom.fep.vo.text.ims.IB_WD_TR_O002;
import org.apache.commons.lang3.StringUtils;

import java.util.Objects;

/**
 * 組送CBS 主機原存跨國晶片提款Confirm交易電文
 * 
 * @author Joseph
 *
 */

public class IBWDTRI002 extends ACBSAction {

	public IBWDTRI002(MessageBase txData) {
		super(txData, new IB_WD_TR_I002());
	}
...
//	private SmsmsgExtMapper smsmsgExtMapper = SpringBeanFactoryUtil.getBean(SmsmsgExtMapper.class);
	...
	public FEPReturnCode getCbsTita(String txType) throws Exception {
		//組CBS 原存交易Request電文, 電文內容格式請參照: D_I1_合庫FEP_主機電文規格-原存行國際提款交易V1.0(111xxxx).doc
		IB_WD_TR_I002 cbsTita = new IB_WD_TR_I002();
		// HEADER
	...
	public FEPReturnCode processCbsTota(String cbsTota, String type) throws Exception {
		/* 電文內容格式請參照TOTA電文格式(IB_WD_TR_O002) */
		/* 拆解主機回應電文 */
		IB_WD_TR_O002 tota = new IB_WD_TR_O002();
	 ...
	 * @throws Exception
	 */
	private FEPReturnCode updateFEPTxn(IB_WD_TR_O002 cbsTota, String type) throws Exception {
