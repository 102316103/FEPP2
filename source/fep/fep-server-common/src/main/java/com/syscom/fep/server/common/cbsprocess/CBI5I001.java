...
import com.syscom.fep.vo.text.ims.CB_I5_I001;
import com.syscom.fep.vo.text.ims.CB_I5_O001;
import org.apache.commons.lang3.StringUtils;

import java.util.Calendar;

/**
 * 組送CBS主機自行企業無卡存款授權存入查詢Request交易電文
 *
 * @author Joseph
 */

public class CBI5I001 extends ACBSAction {

    public CBI5I001(MessageBase txData) {
        super(txData, new CB_I5_O001());
    }
...
//    private SmsmsgExtMapper smsmsgExtMapper = SpringBeanFactoryUtil.getBean(SmsmsgExtMapper.class);
    ...
    public FEPReturnCode getCbsTita(String txType) throws Exception {
        /* TITA 請參考合庫主機電文規格(CB_I5_I001) */
        // Header
        CB_I5_I001 cbstita = new CB_I5_I001();
        ...
        cbstita.setCARDISSUE_BANK(feptxn.getFeptxnBkno());
        //交易卡片型態
        ...
        //Detail
        cbstita.setTRIN_BANKNO(feptxn.getFeptxnBkno() + "0000");
        cbstita.setTROUT_BANKNO(feptxn.getFeptxnBkno() + "0000");
        cbstita.setTOACT(atmReq.getTADATA().substring(0, 6));
        cbstita.setTXMEMO(atmReq.getCARDDATA().substring(21, 31));
        cbstita.setD9CNO(atmReq.getCARDDATA().substring(6, 19));
    ...
    public FEPReturnCode processCbsTota(String cbsTota, String type) throws Exception {
        /* 電文內容格式請參照TOTA電文格式(CB_I5_O001) */
        /* 拆解主機回應電文 */
        CB_I5_O001 tota = new CB_I5_O001();
     ...
     * @throws Exception
     */
    private FEPReturnCode updateFEPTxn(CB_I5_O001 cbsTota) throws Exception {
