...
import com.syscom.fep.vo.text.ims.AB_WW_I001;
import com.syscom.fep.vo.text.ims.AB_WW_O001;

public class ABWWI001 extends ACBSAction {

	public ABWWI001(MessageBase txData) {
		super(txData, new AB_WW_O001());
	}
...
//	private SmsmsgExtMapper smsmsgExtMapper = SpringBeanFactoryUtil.getBean(SmsmsgExtMapper.class);
	...
	public FEPReturnCode getCbsTita(String txType) throws Exception {
		/* TITA 請參考合庫主機電文規格(AB_WW_I001) */
		// Header
		AB_WW_I001 cbstita = new AB_WW_I001();
		...
		cbstita.setPROCESS_TYPE("WDE"); //提款
		// 財金營業日(西元年須轉民國年)
	...
	public FEPReturnCode processCbsTota(String cbsTota, String type) throws Exception {
		/* 電文內容格式請參照TOTA電文格式(AB_WW_O001) */
		/* 拆解主機回應電文 */
		AB_WW_O001 tota = new AB_WW_O001();
	 ...
	 * @throws Exception
	 */
	private FEPReturnCode updateFEPTxn(AB_WW_O001 cbsTota) throws Exception {
	 ...
	 */
	private void insertSMSMSG(AB_WW_O001 cbsTota) throws ParseException {
