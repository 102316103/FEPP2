...
import com.syscom.fep.vo.text.ims.IB_WW_I002;
import com.syscom.fep.vo.text.ims.IB_WW_O002;
...
/**
 * 組送CBS 主機原存行跨國提款Confirm交易電文
 * 
 * @author Joseph
 *
 */

public class IBWWI002 extends ACBSAction {

	public IBWWI002(MessageBase txData) {
		super(txData, new IB_WW_I002());
	}
...
//	private SmsmsgExtMapper smsmsgExtMapper = SpringBeanFactoryUtil.getBean(SmsmsgExtMapper.class);
	...
	public FEPReturnCode getCbsTita(String txType) throws Exception {
		...
		IB_WW_I002 cbsTita = new IB_WW_I002();
		...
		cbsTita.setDRVS(StringUtils.repeat(" ", 380)); // 保留欄位
	...
	public FEPReturnCode processCbsTota(String cbsTota, String type) throws Exception {
		/* 電文內容格式請參照TOTA電文格式(IB_WW_O002) */
		/* 拆解主機回應電文 */
		IB_WW_O002 tota = new IB_WW_O002();
	 ...
	 * @throws Exception
	 */
	private FEPReturnCode updateFEPTxn(IB_WW_O002 cbsTota, String type) throws Exception {
