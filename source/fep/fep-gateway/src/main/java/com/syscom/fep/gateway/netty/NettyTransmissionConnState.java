...
public enum NettyTransmissionConnState {
    // Client Side
    ...
    private NettyTransmissionConnState(String description) {
    ...
    public static boolean isClientConnected(NettyTransmissionConnState state) {
