...
public interface DataSourceConstant {
    /**
     * DataSource Name with lower case, please refer {@link FEPDBName#FEPDB}
     */
    public static final String DS_NAME = "fepdb";
    /**
    ...
    default void printConstant() {
        Field[] fields = DataSourceConstant.class.getDeclaredFields();
