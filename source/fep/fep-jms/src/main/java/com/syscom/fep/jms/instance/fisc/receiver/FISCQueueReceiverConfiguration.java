...
@EnableJms
@Validated
@ConfigurationProperties(prefix = FISCQueueReceiverConstant.CONFIGURATION_PROPERTIES_PREFIX)
@ConditionalOnProperty(value = {
        FISCQueueReceiverConstant.CONFIGURATION_PROPERTIES_QUEUEMANAGER,
        FISCQueueReceiverConstant.CONFIGURATION_PROPERTIES_CHANNEL,
        FISCQueueReceiverConstant.CONFIGURATION_PROPERTIES_CONNNAME,
        FISCQueueReceiverConstant.CONFIGURATION_PROPERTIES_USER,
        FISCQueueReceiverConstant.CONFIGURATION_PROPERTIES_PASSWORD})
@RefreshScope
public class FISCQueueReceiverConfiguration implements FISCQueueReceiverConstant {
