package com.syscom.fep.jms.instance.fisc.receiver.alternative;
...
@EnableJms
@Validated
@ConfigurationProperties(prefix = FISCQueueReceiverAlternativeConstant.CONFIGURATION_PROPERTIES_PREFIX)
@ConditionalOnProperty(value = {
        FISCQueueReceiverAlternativeConstant.CONFIGURATION_PROPERTIES_QUEUEMANAGER,
        FISCQueueReceiverAlternativeConstant.CONFIGURATION_PROPERTIES_CHANNEL,
        FISCQueueReceiverAlternativeConstant.CONFIGURATION_PROPERTIES_CONNNAME,
        FISCQueueReceiverAlternativeConstant.CONFIGURATION_PROPERTIES_USER,
        FISCQueueReceiverAlternativeConstant.CONFIGURATION_PROPERTIES_PASSWORD})
@RefreshScope
public class FISCQueueReceiverAlternativeConfiguration implements FISCQueueReceiverAlternativeConstant {
