 ...
 * @author Richard
 */
public interface EmsQueueSenderConstant {
    /**
     * Instance Name with lower case, please refer {@link JmsMsgInstanceName#EMS}
     */
    public static final String INSTANCE_NAME = "ems.sender";
    public static final String CONFIGURATION_PROPERTIES_PREFIX = "spring.fep.jms." + INSTANCE_NAME;
    public static final String CONFIGURATION_PROPERTIES_PREFIX_PROP = CONFIGURATION_PROPERTIES_PREFIX + ".prop[0]";
    ...
    public static final String JMS_OPERATOR_LIST = INSTANCE_NAME + "JmsOperatorList";

    default void printConstant() {
        Field[] fields = EmsQueueSenderConstant.class.getDeclaredFields();
