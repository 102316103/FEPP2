...
@EnableJms
@Validated
@ConfigurationProperties(prefix = BatchQueueConstant.CONFIGURATION_PROPERTIES_PREFIX)
@ConditionalOnProperty(value = {
        BatchQueueConstant.CONFIGURATION_PROPERTIES_QUEUEMANAGER,
        BatchQueueConstant.CONFIGURATION_PROPERTIES_CHANNEL,
        BatchQueueConstant.CONFIGURATION_PROPERTIES_CONNNAME,
        BatchQueueConstant.CONFIGURATION_PROPERTIES_USER,
        BatchQueueConstant.CONFIGURATION_PROPERTIES_PASSWORD})
@RefreshScope
public class BatchQueueConfiguration implements BatchQueueConstant {
