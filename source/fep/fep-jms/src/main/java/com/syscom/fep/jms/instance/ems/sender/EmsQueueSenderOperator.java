...
public class EmsQueueSenderOperator extends JmsPayloadOperator {
    private static final LogHelper logger = LogHelperFactory.getJmsLogger();
    private JmsListenerEndpointRegistry registry;
    private JmsTemplate jmsTemplate;
    private MessageConverter messageConverter;

    public EmsQueueSenderOperator(JmsListenerEndpointRegistry registry, JmsTemplate jmsTemplate, MessageConverter messageConverter) {
