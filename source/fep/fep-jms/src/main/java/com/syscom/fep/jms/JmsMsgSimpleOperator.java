...
/**
 * JMS訊息發送, 注意收發的訊息物件是Serializable
 *
 * @author Richard
 */
@Component
...
public class JmsMsgSimpleOperator implements JmsOperator<Serializable, Serializable>, JmsMsgConstant {
    private static final LogHelper logger = LogHelperFactory.getJmsLogger();
    @Autowired
    private JmsListenerEndpointRegistry registry;
    @Qualifier(SIMPLE_JMS_TEMPLATE)
    @Autowired
    private JmsTemplate jmsTemplate;
    @Qualifier(SIMPLE_MESSAGE_CONVERTER)
    @Autowired
