...
public interface DataSourceEncConstant {
    /**
     * DataSource Name with lower case, please refer {@link FEPDBName#DESDB}
     */
    public static final String DS_NAME = "desdb";
    /**
    ...
    default void printConstant() {
        Field[] fields = DataSourceEncConstant.class.getDeclaredFields();
