...
public interface DataSourceDeslogConstant {
    /**
     * DataSource Name with lower case, please refer {@link FEPDBName#DESLOGDB}
     */
    public static final String DS_NAME = "deslogdb";
    /**
    ...
    default void printConstant() {
        Field[] fields = DataSourceDeslogConstant.class.getDeclaredFields();
