...
public class ${xlsxFile.className} {
    ...
    public static class ${xlsxFile.className}_Body_MsgRq_SvcRq {
        ...
        private ${xlsxFile.className}_Body_MsgRq_SvcRq_SendData senddata;
        <#--  基本屬性，getter、setter -->
        public ${xlsxFile.className}_Body_MsgRq_SvcRq_SendData getSendData() {
            return senddata;
        }
        public void setSendData(${xlsxFile.className}_Body_MsgRq_SvcRq_SendData senddata) {
    ...
    <#-- 處理SENDDATA屬性 -->
    @XStreamAlias("SENDDATA")
    public static class ${xlsxFile.className}_Body_MsgRq_SvcRq_SendData {
        <#-- 定制屬性 -->
        <#list xlsxFile.xlsxList as xlsx>
        <#if "SENDDATA" == xlsx.headerBody?upper_case>
        private String ${xlsx.name};
        </#if>
        </#list>
