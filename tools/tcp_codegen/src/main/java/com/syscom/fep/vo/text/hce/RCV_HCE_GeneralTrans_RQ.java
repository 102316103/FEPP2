...
public class RCV_HCE_GeneralTrans_RQ {
    ...
    public static class RCV_HCE_GeneralTrans_RQ_Body {
		...
		public String toString() {
			return "RCV_HCE_GeneralTrans_RQ_Body [rq=" + rq + "]";
		}
    ...
    public static class RCV_HCE_GeneralTrans_RQ_Body_MsgRq {
		...
		@Override
		public String toString() {
			return "RCV_HCE_GeneralTrans_RQ_Body_MsgRq [header=" + header + ", svcRq=" + svcRq + "]";
		}
    ...
    public static class RCV_HCE_GeneralTrans_RQ_Body_MsgRq_Header {
		...
		@Override
		public String toString() {
			return "RCV_HCE_GeneralTrans_RQ_Body_MsgRq_Header [CLIENTTRACEID=" + CLIENTTRACEID + ", CHANNEL=" + CHANNEL
    ...
    public static class RCV_HCE_GeneralTrans_RQ_Body_MsgRq_SvcRq {
		...
		@Override
		public String toString() {
			return "RCV_HCE_GeneralTrans_RQ_Body_MsgRq_SvcRq [INDATE=" + INDATE + ", INTIME=" + INTIME + ", IPADDR="
					+ IPADDR + ", TXNTYPE=" + TXNTYPE + ", TERMINALID=" + TERMINALID + ", TERMINAL_TYPE="
					+ TERMINAL_TYPE + ", TERMINAL_CHECKNO=" + TERMINAL_CHECKNO + ", FSCODE=" + FSCODE + ", PCODE="
					+ PCODE + ", TRANSAMT=" + TRANSAMT + ", TRNSFROUTBANK=" + TRNSFROUTBANK + ", TRNSFROUTACCNT="
					+ TRNSFROUTACCNT + ", IC_SEQNO=" + IC_SEQNO + ", ICMARK=" + ICMARK + ", IC_TAC_LEN=" + IC_TAC_LEN
					+ ", IC_TAC=" + IC_TAC + ", TRNSFRINBANK=" + TRNSFRINBANK + ", TRNSFRINACCNT=" + TRNSFRINACCNT
					+ ", TRANSTYPEFLAG=" + TRANSTYPEFLAG + ", TEXTMARK=" + TEXTMARK + ", ORITXSTAN=" + ORITXSTAN
					+ ", IC_TAC_DATE=" + IC_TAC_DATE + ", IC_TAC_TIME=" + IC_TAC_TIME + "]";
		}
	...
	@Override
	public String toString() {
		return "RCV_HCE_GeneralTrans_RQ [xmlnsSoapEnv=" + xmlnsSoapEnv + ", xmlnsXsi=" + xmlnsXsi + ", header=" + header
				+ ", body=" + body + "]";
	}
