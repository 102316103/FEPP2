...
public class SEND_EATM_FC2_FPC extends WebatmXmlBase {
    @XStreamAsAttribute
    ...
    private SEND_EATM_FC2_FPC_Body body;

    public SEND_EATM_FC2_FPC_Body getBody() {
        return body;
    }
    public void setBody(SEND_EATM_FC2_FPC_Body body) {
        this.body = body;
    }
    @XStreamAlias("soap:Body")
    public static class SEND_EATM_FC2_FPC_Body {
        @XStreamAlias("NS1:MsgRs")
        private SEND_EATM_FC2_FPC_Body_NS1MsgRs rs;
        public SEND_EATM_FC2_FPC_Body_NS1MsgRs getRs() {
            return rs;
        }
        public void setRs(SEND_EATM_FC2_FPC_Body_NS1MsgRs rs) {
            this.rs = rs;
        }
    }
    @XStreamAlias("NS1:MsgRs")
    public static class SEND_EATM_FC2_FPC_Body_NS1MsgRs {
        @XStreamAsAttribute
        @XStreamAlias("xmlns:NS1")
        private String xmlnsNs1="http://www.ibm.com.tw/esb";
        @XStreamAlias("Header")
        private SEND_EATM_FC2_FPC_Body_MsgRs_Header header;
        @XStreamAlias("SvcRs")
        private SEND_EATM_FC2_FPC_Body_MsgRs_SvcRs svcRs;
        public SEND_EATM_FC2_FPC_Body_MsgRs_Header getHeader() {
            return header;
        }
        public void setHeader(SEND_EATM_FC2_FPC_Body_MsgRs_Header header) {
            this.header = header;
        }
        public SEND_EATM_FC2_FPC_Body_MsgRs_SvcRs getSvcRs() {
            return svcRs;
        }
        public void setSvcRq(SEND_EATM_FC2_FPC_Body_MsgRs_SvcRs svcRs) {
            this.svcRs = svcRs;
        }
    }

    @XStreamAlias("Header")
    public static class SEND_EATM_FC2_FPC_Body_MsgRs_Header {
    ...
    @XStreamAlias("SvcRs")
    public static class SEND_EATM_FC2_FPC_Body_MsgRs_SvcRs {
