...
public class SEND_EATM_FAA_CCP1PC extends WebatmXmlBase {
    @XStreamAsAttribute
    ...
    private SEND_EATM_FAA_CCP1PC_Body body;

    public SEND_EATM_FAA_CCP1PC_Body getBody() {
        return body;
    }
    public void setBody(SEND_EATM_FAA_CCP1PC_Body body) {
        this.body = body;
    }
    @XStreamAlias("soap:Body")
    public static class SEND_EATM_FAA_CCP1PC_Body {
        @XStreamAlias("NS1:MsgRs")
        private SEND_EATM_FAA_CCP1PC_Body_NS1MsgRs rs;
        public SEND_EATM_FAA_CCP1PC_Body_NS1MsgRs getRs() {
            return rs;
        }
        public void setRs(SEND_EATM_FAA_CCP1PC_Body_NS1MsgRs rs) {
            this.rs = rs;
        }
    }
    @XStreamAlias("NS1:MsgRs")
    public static class SEND_EATM_FAA_CCP1PC_Body_NS1MsgRs {
        @XStreamAsAttribute
        @XStreamAlias("xmlns:NS1")
        private String xmlnsNs1="http://www.ibm.com.tw/esb";
        @XStreamAlias("Header")
        private SEND_EATM_FAA_CCP1PC_Body_MsgRs_Header header;
        @XStreamAlias("SvcRs")
        private SEND_EATM_FAA_CCP1PC_Body_MsgRs_SvcRs svcRs;
        public SEND_EATM_FAA_CCP1PC_Body_MsgRs_Header getHeader() {
            return header;
        }
        public void setHeader(SEND_EATM_FAA_CCP1PC_Body_MsgRs_Header header) {
            this.header = header;
        }
        public SEND_EATM_FAA_CCP1PC_Body_MsgRs_SvcRs getSvcRs() {
            return svcRs;
        }
        public void setSvcRq(SEND_EATM_FAA_CCP1PC_Body_MsgRs_SvcRs svcRs) {
            this.svcRs = svcRs;
        }
    }

    @XStreamAlias("Header")
    public static class SEND_EATM_FAA_CCP1PC_Body_MsgRs_Header {
    ...
    @XStreamAlias("SvcRs")
    public static class SEND_EATM_FAA_CCP1PC_Body_MsgRs_SvcRs {
        ...
        @XStreamOmitField
        @Field(length = 4)
        private String PFILLER2 = StringUtils.EMPTY;
        @XStreamOmitField
        @Field(length = 2)
        private String S7 =  ";/";
        @XStreamOmitField
        @Field(length = 17)
        private String PFILLER3 = StringUtils.EMPTY;
        @XStreamOmitField
        @Field(length = 2)
        private String S8 =  ";/";
        @XStreamOmitField
        ...
        @XStreamOmitField
        @Field(length = 8)
        private String PFILLER4 = StringUtils.EMPTY;
        @XStreamOmitField
        @Field(length = 2)
        private String S13 =  ";/";
        @XStreamOmitField
        ...
        @XStreamOmitField
        @Field(length = 2)
        private String PFILLER5 = StringUtils.EMPTY;
        @XStreamOmitField
        @Field(length = 2)
        private String S15 =  ";/";
        @XStreamOmitField
        ...
        @XStreamOmitField
        @Field(length = 3)
        private String PFILLER6 = StringUtils.EMPTY;
        @XStreamOmitField
        @Field(length = 2)
        private String S17 = ";#";
        @XStreamOmitField
        ...
        public String getPFILLER2(){
            return PFILLER2;
        }
        public void setPFILLER2(String value) {
            this.PFILLER2 = value;
        }
        public String getS7(){
            return S7;
        ...
        public String getPFILLER3(){
            return PFILLER3;
        }
        public void setPFILLER3(String value) {
            this.PFILLER3 = value;
        }
        public String getS8(){
            return S8;
        ...
        public String getPFILLER4(){
            return PFILLER4;
        }
        public void setPFILLER4(String value) {
            this.PFILLER4 = value;
        }
        ...
        public String getPFILLER5(){
            return PFILLER5;
        }
        public void setPFILLER5(String value) {
            this.PFILLER5 = value;
        }
        ...
        public String getPFILLER6(){
            return PFILLER6;
        }
        public void setPFILLER6(String value) {
            this.PFILLER6 = value;
        }
