...
public class Syscomaudittrail extends BaseModel {
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getUpdatetable() == null) ? 0 : getUpdatetable().hashCode());
        result = prime * result + ((getUpdateprimarykey() == null) ? 0 : getUpdateprimarykey().hashCode());
        result = prime * result + ((getDataimage() == null) ? 0 : getDataimage().hashCode());
        return result;
    }
