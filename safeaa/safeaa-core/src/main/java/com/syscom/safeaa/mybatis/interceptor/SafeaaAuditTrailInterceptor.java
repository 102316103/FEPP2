...
import com.syscom.safeaa.mybatis.mapper.SyscomaudittrailMapper;
import com.syscom.safeaa.mybatis.model.Syscomaudittrail;
import com.syscom.safeaa.mybatis.vo.MybatisMethod;
 ...
 */
@Component
@ConfigurationProperties(prefix = "spring.safeaa.mybatis.interceptor.audittrail")
@ConditionalOnProperty(prefix = "spring.safeaa.mybatis.interceptor.audittrail", name = "enable", havingValue = "true")
@RefreshScope
@Intercepts({
        @Signature(type = Executor.class, method = "update", args = {MappedStatement.class, Object.class})
})
public class SafeaaAuditTrailInterceptor implements Interceptor {
    private static final String CLASS_NAME = SafeaaAuditTrailInterceptor.class.getSimpleName();
    ...
    private SafeaaInsertAuditTrailThread insertAuditTrailThread = null;
    @Value("#{'${spring.safeaa.mybatis.interceptor.audittrail.ignore-tablename-prefix-list:SYSCOMAUDITTRAIL}'.split(',')}")
    private List<String> auditIgnoreTableNamePrefixList;

    @PostConstruct
    public void initialization() {
        log.info("[", CLASS_NAME, "]start to intercept...");
        insertAuditTrailThread = new SafeaaInsertAuditTrailThread();
    }
    ...
    private class SafeaaInsertAuditTrailThread extends Thread {
        private final List<Invocation> list = Collections.synchronizedList(new ArrayList<>());
        private boolean running = true;

        public SafeaaInsertAuditTrailThread() {
            super("SafeaaInsertAuditTrailThread");
        ...
        private void processByEntity(
            ...
            // 取得mapper的實例
            Object mapper = SafeaaSpringBeanFactoryUtil.getBean(mapplerClass);
        ...
        private void insertAuditTrail(String mapperClassSimpleName, String tableNameSuffix, SqlCommandType commandType, Object[] args, Object entityBefore, Object entityAfter, long updateUser) {
            ...
            SyscomaudittrailMapper syscomaudittrailMapper = SafeaaSpringBeanFactoryUtil.getBean(SyscomaudittrailMapper.class);
