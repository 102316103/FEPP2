...
public interface DataSourceSafeaaConstant {
    /**
     * DataSource Name
     */
    public static final String DS_NAME = "safeaadb";
    /**
    ...
    /**
     * properties key for datasource name
     */
    public static final String CONFIGURATION_PROPERTIES_DATASOURCENAME = CONFIGURATION_PROPERTIES_PREFIX + ".data-source-name";
    /**
    ...
    default void printConstant() {
        Field[] fields = DataSourceSafeaaConstant.class.getDeclaredFields();
