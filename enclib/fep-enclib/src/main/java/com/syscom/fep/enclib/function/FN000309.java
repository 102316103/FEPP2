...
public class FN000309 extends ENCFunction {
     ...
     * @param suipData
     */
    public FN000309(SuipData suipData) {
        super(suipData);
    }
    ...
    public SuipData process() throws Exception {
        ...
        rc = this.checkFN000309Data(refSuip);
        ...
        // 4.拆解Suip回傳結果
        rc = this.parseFN000309ReturnData(rtn);
        return this.suipData;
    }

    private ENCRC checkFN000309Data(RefBase<SuipData[]> suip) {
    ...
    private ENCRC parseFN000309ReturnData(String suipReturn) throws DecoderException {
